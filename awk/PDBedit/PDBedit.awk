...
#		if ( PDBdata[i] ~ /^ATOM/){
			printf "ATOM %6d %-3s%-7s%-2s%-4d%11.3f %7.3f %7.3f\n",i,PDBatomname[i],PDBresiduename[i],PDBresiduenum0[i],PDBresiduenum[i],PDBcoordx[i],PDBcoordy[i],PDBcoordz[i] >> filename".pdb"
#		}
	}
}

...
# height_size=`echo  ${width_size} * 320 | bc`  #
#################################################
...
paraRfil=~/Report/2012-09/graph/para_2Dpmf_TREMD_pymbar_2012-09-25.R
...
name.out <- paste("~/Report/2012-09/tiff/pmf_2D_TREMD_pymbar_2012-09-25",sep="")

size.width <- "${width_size}"
size.height <- "${height_size}"

size <- ${size}

source("~/Report/2012-09/graph/graph_2Dpmf_TREMD_pymbar_2012-09-25.R")
EOF

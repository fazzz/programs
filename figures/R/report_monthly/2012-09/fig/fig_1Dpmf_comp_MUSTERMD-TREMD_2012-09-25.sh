...
name.out <- "${dirs}/tiff/pmf1D_comp_1Dpmf_comp_MUSTERMD-TREMD_2012-09-25_${pname}_${AACGflag[1]}_mZ=${mZ[1]}_TZ=${TZs[1]}_${phsiflag}"

source("${dirs}/graph/graph_1Dpmf_comp_MUSTERMD-TREMD_2012-09-25.R")
EOF

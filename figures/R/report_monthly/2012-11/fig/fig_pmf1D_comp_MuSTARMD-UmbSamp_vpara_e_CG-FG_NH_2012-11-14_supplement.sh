...
paraRfil=${dirs}/graph/para_fig_pmf1D_comp_MuSTRAMD-UmbSam_vpara_e_CG-FG_NH_2012-11-13_supplement.sh
...
name.out <- "${dirs}/tiff/fig_pmf1D_comp_MuSTRAMD-UmbSam_vpara_e_CG-FG_NH_2012-11-13_${name}_${phsiflag}_supplement"

source("~/calspa/TACCM_CGAAREMD/AD/graph/graph_pmf1D_comp_MuSTARMD-UmbSam_vpara_e_CG-FG_NH_2012-11-13_supplement.R")
EOF
Rscript ${paraRfil}; echo ${paraRfil}

display ${dirs}/tiff/fig_pmf1D_comp_MuSTRAMD-UmbSam_vpara_e_CG-FG_NH_2012-11-13_${name}_${phsiflag}_supplement.tiff &

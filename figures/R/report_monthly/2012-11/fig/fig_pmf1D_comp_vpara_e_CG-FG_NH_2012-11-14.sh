...
opt=(dummy name parabasefile phsiflag num1 num2 num3 )
nopt=${#opt[*]}
...
name.out <- "${dirs}/tiff/fig_pmf1D_comp_vpara_e_CG-FG_NH_2012-11-11_${name}_${phsiflag}_${num1}_${num2}_${num3}"

source("~/calspa/TACCM_CGAAREMD/AD/graph/graph_pmf1D_comp_vpara_e_CG-FG_NH_2012-11-11.R")
EOF
Rscript ${paraRfil}; echo ${paraRfil}

display ${dirs}/tiff/fig_pmf1D_comp_vpara_e_CG-FG_NH_2012-11-11_${name}_${phsiflag}_${num1}_${num2}_${num3}.tiff &

...
paraRfile=${dirOUT}/graph/para_fig_a-f_80ns-MuSTAR_MD-REUS-REMD-TAMD_2Dpmf_2013-08-17.R
...
name.out <- paste(dirout,"/eps/","fig_a-f_80ns-MuSTAR_MD-REUS-REMD-TAMD_2Dpmf_2013-08-17",sep='')

...
parafile=~/calspa/TACCM_CGAAREMD/AD/para/2013-05-04/para_e_CG-FG_NR=8_2_TZ=750_fq=10ps_99SB_KZmax=5000_weljd0.001_mZ=100.sh

source ${parafile}

paraRfile=${dirOUT}/graph/para_MuSTARMD_AD_2Dpmf_2013-07-01.R
...
name.out <- paste(dirout,"/eps/","fig_MuSTARMD_AD_2Dpmf_2013-07-01",sep='')

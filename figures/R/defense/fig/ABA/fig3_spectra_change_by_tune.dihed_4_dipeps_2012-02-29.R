...
dirbase.name <-paste("/misc/ivy3/yamamori/ajisai/TAMD/TAMD/mod_parm/dipep",sep='')
dirbase2.name <- paste("spe_AMBER_TermOn_wdtune_dihed_V_n_term_2012-02-21_pc6",sep='')

file.name=paste("~/defense/eps/ABA/fig_spectrum_effect_by_tuning_TAMD_4dipep_2013-07-09.eps",sep='')

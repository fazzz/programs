...
dirbase.name <- "/home/yamamori/calspa/TAMD/mod_parm/proteins/"
dirbase2.name <- "/home/yamamori/calspa/TAMD_econ/proteins/"
...
for (i in 1:num.proteins) {
  for (j in 1:ntune) {
    ...
    file.names[3]=paste("/home/yamamori/calspa/refcalc-s-ivy3/dipep/",name.proteins[i],"/econ_wdi_NVE_100ps/",name.proteins[i],"Dv_econ_",temp[1],"_100ps_1-10_2ntc",".econ.rmsd.av",sep='')
...
name.out=paste("~/calspa/TAMD/mod_parm/proteins/R/graph_econ_vdt_100ps_wdi_NVE_ABAMD_Ambr_TermOn_dihed_tune_comp_wotune_2012-05-21",sep='')

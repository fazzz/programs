...
dirbase.name <- "/misc/ivy3/yamamori/ajisai/TAMD/TAMD/dipeptides/"
dirbase21.name <-paste("/misc/ivy3/yamamori/ajisai/TAMD/TAMD/mod_parm/dipep",sep='')
dirbase22.name <- paste("econ_wdi_NVE_AMBER_TermOn_wtune_2012-02-29_pc6",sep='')

file.name=paste("~/defense/eps/ABA/fig_econdependnce_dt=1-5fs_T=300K_commp_TAMDvsCMS_4dipep_2013-07-09",sep='')
postscript(file.name,width=6,height=6,horizontal=FALSE,onefile=FALSE,paper="special")
...
for (i in 1:num.res) {
  ...
  file.names[1]<- paste(dirbase21.name,"/",name.res[i],"/",dirbase22.name,"/tune=1.0/",name.res[i],"Dv_econ_",temp[1],"_100ps_1-",numini,".econ.rmsd.av",sep='')
  if ( i == 3 || i == 4 )
  ...
  file.names[3]=paste("/misc/ivy3/yamamori/ajisai/refcalc/refcalc/dipep/",name.res[i],"/econ_wdi_NVE_100ps/",name.res[i],"Dv_econ_",temp[1],"_100ps_1-10_2ntc",".econ.rmsd.av",sep='')
...
#  par(mar=c(7.0,0.0,0.0,0.0))
  ...
  file.names[2]=paste(dirbase.name,name.res[i],"/econ_wdi_NVE_AMBER_TermOn_11-11-17_mvV/",name.res[i],"Dv_econ_",temp[1],"_100ps_1-",numini,".econ.rmsd.av",sep='')  
  file.names[3]=paste("/misc/ivy3/yamamori/ajisai/refcalc/refcalc/dipep/",name.res[i],"/econ_wdi_NVE_100ps/",name.res[i],"Dv_econ_",temp[1],"_100ps_1-10_2ntc",".econ.rmsd.av",sep='')
#  file.names[2]=paste("/misc/ivy3/yamamori/ajisai/refcalc/refcalc/dipep/",name.res[i],"/econ_wdi_NVE_100ps/",name.res[i],"Dv_econ_",temp[1],"_100ps_1-10_2ntc",".econ.rmsd.av",sep='')

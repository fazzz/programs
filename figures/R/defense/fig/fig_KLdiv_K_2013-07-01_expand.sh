...
filename=${dir}/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-03-21/tau=${tau[1]}/mZ=${mZ[1]}/TZ=${TZs[1]}/${pname}/nEX=${numEX}/fq=${TLbase}/KLdv_TAA=${TAA}_TCG=${TCG}_${KZAAo[$mode]}_${KZCGo[$mode]}_${MODES[$mode]}_wx${minx}-${maxx}_wy${miny}-${maxy}.txt

paraRfil=${dirOUT}/graph/graph_fig_KLdiv_K_2013-07-01_expand.R
...
name.title <- paste("${dirOUT}/eps/fig_KLdiv_K_2013-07-01_expand",sep="")

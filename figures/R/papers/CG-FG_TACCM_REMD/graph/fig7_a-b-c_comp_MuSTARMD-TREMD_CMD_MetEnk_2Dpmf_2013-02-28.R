...
file.name <- "~/papers/CG-FG_TACCM_REMD/eps/fig7_a-b-c_comp_MuSTARMD-TREMD_CMD_MetEnk_2Dpmf_2013-06-04_KAA=3000_TZ=3000.eps"
#tiff(file.name,width=800,height=230)

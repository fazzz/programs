...
pname <-"SB_KZMAX=500_NR4_woeljd0.001"

numEX<-"1000"
TLbase<-"10"

name.title <- paste("/home/yamamori/papers/CG-FG_TACCM_REMD//eps/fig2-a-l_comp_MuSTARMD-REMD-REUS-TAMD-CMD_AD_dihedtraj_2013-08-20",sep="")

...
name.title <- paste("/home/yamamori/papers/CG-FG_TACCM_REMD//eps/fig2-a-b-c_comp_MuSTARMD-TREMD-CMD_AD_dihedtraj_2013-05-08_2",sep="")
...
#tiff(file.name,width=500,height=700)
#postscript(file.name,width=7.0,height=8.2,horizontal=FALSE,onefile=FALSE,paper="special")
#postscript(file.name,width=6.5,height=8.2,horizontal=FALSE,onefile=FALSE,paper="special")

...
name.out <- paste(dirout,"/eps/","fig3_a-b-c-d-e-f_comp_MuSTARMD-other_methods_AD_2Dpmf_2013-05-08_yobi",sep='')
...
source("~/papers/CG-FG_TACCM_REMD/fel_wFillConMap_wrange_worwoaxis_wpoints_wlines.R")

source("~/papers/CG-FG_TACCM_REMD/fel_wFillConBar_wmai.R")

source("~/papers/CG-FG_TACCM_REMD/fel_wFillConMapbox_wpoints.R")
...
felwFillConMapwrangeworwoaxiswpointswlines(name,label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",xrange=xrange,yrange=yrange,xrange.axis=xrange.axis,yrange.axis=yrange.axis,mai=c(0.0,0.8,0.5,0.0),xaflag="f",norm="T",pdata=pdatanamedummy,iro=c("white","white","white"),ldata=ldataname3)
...
felwFillConMapwrangeworwoaxiswpointswlines(name,label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",xrange=xrange,yrange=yrange,xrange.axis=xrange.axis,yrange.axis=yrange.axis,mai=c(0.0,0.0,0.5,0.1),xaflag="f",yaflag="f",norm="T",pdata=pdatanamedummy,iro=c("white","white","white"),ldata=ldataname3)
...
felwFillConMapwrangeworwoaxiswpointswlines(name,label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",xrange=xrange,yrange=yrange,xrange.axis=xrange.axis,yrange.axis=yrange.axis,mai=c(0.0,0.8,0.0,0.0),xaflag="f",norm="T",pdata=pdatanamedummy,iro=c("white","white","white"),ldata=ldataname3)
...
felwFillConMapwrangeworwoaxiswpointswlines(name,label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",xrange=xrange,yrange=yrange,xrange.axis=xrange.axis,yrange.axis=yrange.axis,mai=c(0.0,0.0,0.0,0.1),xaflag="f",yaflag="f",norm="T",pdata=pdatanamedummy,iro=c("white","white","white"),ldata=ldataname3)
...
felwFillConMapwrangeworwoaxiswpointswlines(name,label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",xrange=xrange,yrange=yrange,xrange.axis=xrange.axis,yrange.axis=yrange.axis,mai=c(0.8,0.8,0.0,0.0),norm="T",pdata=pdatanamedummy,iro=c("white","white","black"),ldata=ldataname3)

...
file.name <- "~/papers/CG-FG_TACCM_REMD/eps/fig7_a-b-c_comp_MuSTARMD-TREMD_CMD_MetEnk_2Dpmf_2013-02-28.eps"
#tiff(file.name,width=${tiffwidth},height=${tiffheight})
postscript(file.name,width=7.0,height=2.6,horizontal=FALSE,onefile=FALSE,paper="special")

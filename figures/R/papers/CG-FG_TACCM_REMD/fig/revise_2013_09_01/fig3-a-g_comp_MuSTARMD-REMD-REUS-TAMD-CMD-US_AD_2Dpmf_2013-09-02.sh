...
paraRfile=${dirOUT}/graph/para_UmbSamp_AD_2Dpmf_2013-09-02.R
...
name.out <- paste(dirout,"/eps/","fig3-a-g_comp_MuSTARMD-REMD-REUS-TAMD-CMD_AD_2Dpmf_2013-09-02",sep='')
...
parafile_MuSTARMD=~/calspa/TACCM_CGAAREMD/AD/para/2013-08-28/para_e_CG-FG_NR=8_TZ=1000_fq=10ps_99SB_KZmax=1000_weljd0.001_mZ=100.sh
...
parafile_TREMD=~/calspa/refcalc/REMD/AD/para/para_s_REMD_vac_ff99SB_2013-08-17_TZ=300-1200.sh
...
parafile_REUS=~/calspa/refcalc/REUS/AD/para/2013-08-30/para_s_REUSMD_vac_ff99SB_Nbin=4x4_K=0.5_5ns_freq=10ps_2013-08-30.sh

...
parafileTAMD=~/calspa/TACCM/AD/para/2013-08-20/para_e_ff99SB_2013-08-20_mZ=100_Tz=800.sh
...
paraRfil=${dirOUT}/graph/graph_fig2-a-j_comp_MuSTARMD-REMD-REUS-TAMD-CMD_AD_dihedtraj_2013-09-02.R
...
name.title <- paste("${dirOUT}/eps/fig2-a-l_comp_MuSTARMD-REMD-REUS-TAMD-CMD_AD_dihedtraj_2013-09-02",sep="")

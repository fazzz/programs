...
paraRfil=${dir}/graph/fig6_a-b-c_comp_MuSTARMD-TREMD_CMD_MetEnk_2Dpmf_2013-02-28.R
...
file.name <- "~/papers/CG-FG_TACCM_REMD/tiff/fig6_a-b-c_comp_MuSTARMD-TREMD_CMD_MetEnk_2Dpmf_2013-02-28.tiff"
...
nf <- layout(matrix(c(1,2,3,4),1,4,byrow=TRUE),c(3.5,3,3,0.5),c(1))

...
name.title <- paste("${dirOUT}/eps/fig6-a-b_comp_MuSTARMD-CMD_MetEnk_dihedangdistraj_2013-02-28",sep="")
...
for (i in 1:2) {
    ...
    if ( i == 1 ) {
        axis(2,yaxp=yrange.axis,lwd=2.0,cex=0.4)
        mtext(label.y,side=2,line=3.0,cex=0.8)
    }
}

...
paraRfil=~/papers/CG-FG_TACCM_REMD/fig/para_fig3-c_CMD_FG_2Dpmf_FASYS_2012-08-08.R
...
name.out <- "~/papers/CG-FG_TACCM_REMD/tiff/fig3-c_CMD_FG_2Dpmf_FASYS_2012-08-08"

...
name.title <- paste("${dirOUT}/eps/fig6-a-b_comp_MuSTARMD-CMD_MetEnk_dihedangdistraj_2013-05-26",sep="")
...
for (i in 1:2) {
    ...
    filex.names <- "~/calspa/TACCM_CGAAREMD/MetEnk/e_CG-FG_CMD_NH_2012-06-04/1FG2CG/tau=1.0/mZ=100.00/ep=0.2/cutoff=4.7/TZ=2000/2CG_2013-05-24_KZ=1500/freq=1/anl/MetEnk_Z_T=2000_1.ddist_n"

    filey.names <- "~/calspa/TACCM_CGAAREMD/MetEnk/e_CG-FG_CMD_NH_2012-06-04/1FG2CG/tau=1.0/mZ=100.00/ep=0.2/cutoff=4.7/TZ=2000/2CG_2013-05-24_KZ=1500/freq=1/anl/MetEnk_Z_T=2000_1.ddist"

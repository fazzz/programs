...
name.out <- paste(dirout,"/tiff/","fig1_UmbSamp_AD_2Dpmf_2013-02-28",sep='')
...
felwFillConMapwrange(name.pmf,label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",xrange=xrange,yrange=yrange)

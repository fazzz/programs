...
paraRfil=${dir}/graph/fig1_UmbSamp_MetEnk_2Dpmf_2013-02-28.R
...
file.name <- "~/papers/CG-FG_TACCM_REMD/tiff/fig1_UmbSamp_MetEnk_2Dpmf_2013-02-28.tiff"
...
nf <- layout(matrix(c(1,2),1,2,byrow=TRUE),c(3.5,1),c(1))
...
felwFillConMapwrangewy(name,label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",xrange=xrange,yrange=yrange,mar=c(5,5,2,0))

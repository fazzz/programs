...
paraRfil=${dir}/fig/para_fig3_a-b-c-d_comp_MuSTARMD-other_methods_AD_2Dpmf_2013-03-07.R
...
file.name <- "~/papers/CG-FG_TACCM_REMD/tiff/fig3_a-b-c-d_comp_MuSTARMD-other_methods_AD_2Dpmf_2013-03-07.tiff"
...
#nf <- layout(matrix(c(1,2,3,4,5),1,5,byrow=TRUE),c(3.5,3,3,3,0.5),c(1))
nf <- layout(matrix(c(1,2,3,4,5,6),2,3,byrow=TRUE),c(3.5,3,0.5,3.5,3,0.5),c(2))
...
felwFillConMapwrangewy(name,label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",xrange=xrange,yrange=yrange,mar=c(5,5,1,0),plot.axis="yes")

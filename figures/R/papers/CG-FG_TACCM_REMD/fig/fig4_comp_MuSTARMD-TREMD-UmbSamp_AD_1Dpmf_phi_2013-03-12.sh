...
name.out <- "${dirOUT}/eps/fig4_comp_MuSTARMD-TREMD-UmbSamp_AD_1Dpmf_phi_2013-02-28"
...
postscript(file.name,width=2.0,height=2.0,horizontal=FALSE,onefile=FALSE,paper="special")

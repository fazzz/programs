...
paraRfil=${dir}/graph/fig5-a-b_comp_MuSTARMD-TREMD_GBSA_AD_2Dpmf_2013-08-24.R

tiffwidth=720
tiffheight=300

parafile_MuSTARMD=~/calspa/InV2InW/AD/para/2013-08-24/para_e_CG-FG_NR=4_TZ=700_fq=10ps_99SB_KZmaz=500_weljd0.001_mZ=100.sh
...
parafile_TREMD=~/calspa/refcalc/REMD/AD/para/2013-08-17/para_s_REMD_GBSA_ff99SB_T=300-500_2013-08-24.sh
...
file.name <- "~/papers/CG-FG_TACCM_REMD/eps/fig5-a-b_comp_MuSTARMD-TREMD_GBSA_AD_2Dpmf_2013-08-24.eps"
...
name <- paste(dirbase,"/tau=",tau_MuSTARMD,"/mZ=",mZ_MuSTARMD,"/TZ=",TZ_MuSTARMD,"/",pname_MuSTARMD,"/nEX=",nEX_MuSTARMD,"/fq=",fq_MuSTARMD,"/pmf/pmf_TAA=300_TCG_300_TZ_700_0.3_500_0_AA_InW",sep="")
cat(name)
...
felwFillConBarwmai(name,label.x=label.x,label.y=label.y,level=level,mai=c(3.2,0.5,0.5,0.2))

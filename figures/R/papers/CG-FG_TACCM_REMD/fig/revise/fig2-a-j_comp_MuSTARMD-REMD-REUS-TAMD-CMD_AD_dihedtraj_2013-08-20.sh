...
parafileMuSTARMD=~/calspa/TACCM_CGAAREMD/AD/para/2012-11-02/para_e_CG-FG_NR=4_TZ=700_fq=10ps_99SB_KZmax=500_weljd0.001_mZ=100.sh
parafileTREMD=~/calspa/refcalc/REMD/AD/para/2013-08-17/para_s_REMD_vac_ff99SB_2013-08-17_TZ=300-600.sh
parafileREUS=~/calspa/refcalc/REUS/AD/para/para_s_REUSMD_vac_ff99SB_Nbin=4x4_K=1_5ns_freq=10ps_2013-08-12.sh
parafileTAMD=~/calspa/TACCM/AD/para/2013-08-17/para_e_ff99SB_2013-08-31_mZ=100_TZ=750.sh
...
paraRfil=${dirOUT}/graph/graph_fig2-a-j_comp_MuSTARMD-REMD-REUS-TAMD-CMD_AD_dihedtraj_2013-08-20.R
...
name.title <- paste("${dirOUT}/eps/fig2-a-l_comp_MuSTARMD-REMD-REUS-TAMD-CMD_AD_dihedtraj_2013-08-20",sep="")
...
#    filex.names<-paste(dirbase.name,proname,"_AA_T=",TAA,".out_1",sep='')
    filex.names<-paste(dirbase.name,proname,"_AA.Theta_1_n_2",sep='')
    filey.names<-paste(dirbase.name,proname,"_AA.Theta_1_n_2",sep='')
...
for (i in 1:2) {
    ...
    filex.names<-paste(dirbase.name,"anl/",proname,"g.CV_1_n_2",sep='')
    filey.names<-paste(dirbase.name,"anl/",proname,"g.CV_1_n_2",sep='')
...
for (i in 1:2) {
    ...
    filex.names<-paste(dirbase.name,"/",proname,"_e_T=",T,".Theta_n",sep='')
    filey.names<-paste(dirbase.name,"/",proname,"_e_T=",T,".Theta_n",sep='')

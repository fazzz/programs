...
parafileMuSTARMD=~/calspa/TACCM_CGAAREMD/AD/para/2012-11-02/para_e_CG-FG_NR=4_TZ=750_fq=10ps_99SB_KZmax=1000_weljd0.001_mZ=100.sh
...
paraRfil=${dirOUT}/graph/para_fig4-c_comp_MuSTARMD-TREMD-REUS-TAMD-UmbSamp_AD_1Dpmf_2013-08-20.R
...
name.out <- "${dirOUT}/eps/fig4-c_comp_MuSTARMD-TREMD-REUS-TAMD-UmbSamp_AD_1Dpmf_2013-08-20"
...
name[2] <- paste("~/papers/CG-FG_TACCM_REMD/FEL_C7eq-C7ax_REMD_2013-08-22.txt")
name[3] <- paste("~/papers/CG-FG_TACCM_REMD/FEL_C7eq-C7ax_MuSTARMD_2013-08-22.txt")
name[4] <- paste("~/papers/CG-FG_TACCM_REMD/FEL_C7eq-C7ax_TAMD_2013-08-22.txt")
name[5] <- paste("~/papers/CG-FG_TACCM_REMD/FEL_C7eq-C7ax_REUS_2013-08-22.txt")

...
paraRfil=${dirOUT}/graph/para_fig4-a-b_comp_MuSTARMD-TREMD-REUS-TAMD-UmbSamp_AD_1Dpmf_2013-08-17.R
...
name.out <- "${dirOUT}/eps/fig4-a-b_comp_MuSTARMD-TREMD-REUS-TAMD-UmbSamp_AD_1Dpmf_2013-08-17"

...
paraRfil=${dir}/graph/fig6_a-b_comp_MuSTARMD-TREMD_GBSA_AD_2Dpmf_2013-02-28.R
...
file.name <- "~/papers/CG-FG_TACCM_REMD/tiff/fig6_a-b_comp_MuSTARMD-TREMD_GBSA_AD_2Dpmf_2013-02-28.tiff"

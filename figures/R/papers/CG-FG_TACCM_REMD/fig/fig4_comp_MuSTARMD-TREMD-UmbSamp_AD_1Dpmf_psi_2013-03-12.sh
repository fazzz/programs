...
name.out <- "${dirOUT}/eps/fig4_comp_MuSTARMD-TREMD-UmbSamp_AD_1Dpmf_psi_2013-02-28"
...
cat(file.name,'\n')
#tiff(file.name,width=800,height=480
#tiff(file.name,width=600,height=360)
postscript(file.name,width=2.0,height=1.0,horizontal=FALSE,onefile=FALSE,paper="special")
...
name[1] <- paste(dirbase1,"/tau=",tau[1],"/mZ=",mZ[1],"/TZ=",TZs[1],"/",pname1,"/nEX=",numEX1,"/fq=",TLbase1,"/pmf/1D/pmf_pymbar_1_TAA=",TAA,"_TCG=",TCG,"_TZ=",TZs[1],"_KZAAo=",KZAAo,"_KZCGo=",KZCGo,"_",AACG,phsiflag,"@",18,sep="")
name[2] <- paste(dirbase2,"/",pname2,"/nEX=",numEX2,"/freq=",TLbase2,"ps","/pmf/1D/pmf_p1",phsiflag,"@",18,sep="")
name[3] <- paste(dirbase3,"/",pname3,"/pmf/1D/pmf_1D_UmbMD_vac_",TLns,"ns_",xy,"=",18,".txt",sep="")

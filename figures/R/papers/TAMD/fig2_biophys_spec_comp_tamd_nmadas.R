...
for (i in 1:num.res) {
  ...
  text(400,1.2,name.res[i],cex=1.5)
  if (i==1) {
  ...
  if (i==1 || i==4  ) {
    axis(2,yaxp=yrange,lwd=2.0,cex=1.5)
  }

  if (i==4 || i==5 || i==6) {
    axis(1,xaxp=xrange,lwd=2.0,cex=1.5)
  }
...
name.out=paste("~/papers/TAMD/fig2.biophys_spec_comp_tamd_nmadas",sep='')

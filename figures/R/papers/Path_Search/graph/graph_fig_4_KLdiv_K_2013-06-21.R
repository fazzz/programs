...
name.title <- paste("/home/yamamori/papers/Path_Search/eps/fig_4_KLdiv_K_2013-06-21",sep="")

leg.pos="topright"
is.leg <- 0

xrange <- c(0,25,5)
xrange.axis <- c(0,25,5)
yrange <- c(0.0,2.1,5)
...
filex.names<-paste("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-05-04/tau=1.0/mZ=100.00/TZ=750/SB_KZMAX=5000_NR8-2_woeljd0.001/nEX=1000/fq=10/KLdv_TAA=300_TCG=300_0_5000_CG_wx-4.0-4.0_wy-4.0-4.0.txt",sep="")
filey.names<-paste("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-05-04/tau=1.0/mZ=100.00/TZ=750/SB_KZMAX=5000_NR8-2_woeljd0.001/nEX=1000/fq=10/KLdv_TAA=300_TCG=300_0_5000_CG_wx-4.0-4.0_wy-4.0-4.0.txt",sep="")

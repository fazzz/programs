...
name.out <- paste(dir,"/eps/","fig_2-a-b-c-d_2DFEL-MixedGaussians_2013-06-21",sep='')
...
name.path <- paste("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-05-04/tau=1.0/mZ=100.00/TZ=750/SB_KZMAX=5000_NR8-2_woeljd0.001/nEX=1000/fq=10/path_TAA=300_TCG=300_0_5000_CG_K=25_@-1.4,1.1-@1.1,-0.8_wx-4.0-4.0_wy-4.0-4.0.txt",sep='')
...
cat("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-05-04/tau=1.0/mZ=100.00/TZ=750/SB_KZMAX=5000_NR8-2_woeljd0.001/nEX=1000/fq=10/pmf2MGaussian_TAA=300_TCG=300_0_5000_CG_K=25_wx-4.0-4.0_wy-4.0-4.0_dx=0.01_dy=0.01_4.txt",'\n')
felwFillConMapwrange("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-05-04/tau=1.0/mZ=100.00/TZ=750/SB_KZMAX=5000_NR8-2_woeljd0.001/nEX=1000/fq=10/pmf2MGaussian_TAA=300_TCG=300_0_5000_CG_K=25_wx-4.0-4.0_wy-4.0-4.0_dx=0.01_dy=0.01_4.txt",label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",mar=c(5,0,1,0),xrange=xrange,yrange=yrange,plot.axis="yes",norm="T")

...
cat("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-03-21/tau=1.0/mZ=50000.00/TZ=750/SB_NR4_wrefd0.1/nEX=1000/fq=10/pmf2MGaussian_TAA=300_TCG=300_0_2000_CG_K=2_wx-2.5-2.5_wy-2.5-2.5.txt",'\n')
felwFillConMapwrangewy("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-03-21/tau=1.0/mZ=50000.00/TZ=750/SB_NR4_wrefd0.1/nEX=1000/fq=10/pmf2MGaussian_TAA=300_TCG=300_0_2000_CG_K=2_wx-2.5-2.5_wy-2.5-2.5.txt",label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",mar=c(5,5,2,0),xrange=xrange,yrange=yrange,plot.axis="yes")

cat("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-03-21/tau=1.0/mZ=50000.00/TZ=750/SB_NR4_wrefd0.1/nEX=1000/fq=10/pmf2MGaussian_TAA=300_TCG=300_0_2000_CG_K=5_wx-2.5-2.5_wy-2.5-2.5.txt",'\n')
felwFillConMapwrange("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-03-21/tau=1.0/mZ=50000.00/TZ=750/SB_NR4_wrefd0.1/nEX=1000/fq=10/pmf2MGaussian_TAA=300_TCG=300_0_2000_CG_K=5_wx-2.5-2.5_wy-2.5-2.5.txt",label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",mar=c(5,0,2,0),xrange=xrange,yrange=yrange,plot.axis="yes")
...
felwFillConMapwrange("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-03-21/tau=1.0/mZ=50000.00/TZ=750/SB_NR4_wrefd0.1/nEX=1000/fq=10/pmf2MGaussian_TAA=300_TCG=300_0_2000_CG_K=18_wx-2.5-2.5_wy-2.5-2.5.txt",label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",mar=c(5,0,2,0),xrange=xrange,yrange=yrange,plot.axis="yes")

cat("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-03-21/tau=1.0/mZ=50000.00/TZ=750/SB_NR4_wrefd0.1/nEX=1000/fq=10/pmf2MGaussian_TAA=300_TCG=300_0_2000_CG_K=19_wx-2.5-2.5_wy-2.5-2.5.txt",'\n')

felwFillConMapwrange("/home/yamamori/calspa/MFEP/AD/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-03-21/tau=1.0/mZ=50000.00/TZ=750/SB_NR4_wrefd0.1/nEX=1000/fq=10/pmf2MGaussian_TAA=300_TCG=300_0_2000_CG_K=19_wx-2.5-2.5_wy-2.5-2.5.txt",label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT",mar=c(5,0,2,0),xrange=xrange,yrange=yrange,plot.axis="yes")

par(mar=c(5,2,2,1))

felwFillConBar("/home/yamamori/calspa/TACCM_CGAAREMD/AD/e_CG-FG_NH_2012-07-27/tau=1.0/mZ=50000.00/TZ=750/SB_NR4_wrefd0.1/nEX=1000/fq=10/pmf/pmf_TAA=300_TCG_300_TZ_750_0.3_0_2000_CG_4_2012-08-21_wrange_-2.5-2.5_-2.5-2.5",label.x=label.x,label.y=label.y,level=level,title=title,kt="F/kBT")

...
filename=${dir}/committor_test_2013-03-24_bo_e_CG-FG_NH_2012-07-27/tau_${tau[1]}/mZ_${mZ[1]}/TZ_${TZs[1]}/${pname}/nEX_${numEX}/fq_${TLbase}/${crdTSL}/anl/comm_hist_2.txt 

paraRfil=${dirOUT}/graph/graph_fig_6-a_commitor_test_hist_2013-06-21.R
...
name.title <- paste("${dirOUT}/eps/fig_6-a_commitor_test_hist_2013-06-21",sep="")

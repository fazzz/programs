...
dirOUT=~/gakkai/News_Letter_2014

filedata=/home/yamamori/data_paper/MuSTAR_MD/fig_3

filenameMuSTARMD=${filedata}/pmf_AD_MuSTAR_MD
filenameTAMD=${filedata}/pmf_AD_TAMD
filenameREUS=${filedata}/pmf_AD_REUS
filenameREMD=${filedata}/pmf_AD_REMD
filenameCMD=${filedata}/pmf_AD_CMD

paraRfile=${dirOUT}/graph/para_AD_2Dpmf_2014-02-05.R
...
name<-paste("${filenameMuSTARMD}",sep='')
cat(name)

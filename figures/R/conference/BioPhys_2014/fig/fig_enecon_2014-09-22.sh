...
parafilename=~/gakkai/BioPhys_2014/para/para_enecon_26_residues_2014-09-22.sh
#parafilename=~/gakkai/BioPhys_2014/para/para_enecon_20_residues_2014-09-23.sh
#parafilename=~/gakkai/BioPhys_2014/para/para_enecon_10_residues_2014-09-23.sh

source ${parafilename}

dir=~/calspa/TAMD_econ/dipep_2014-09-14_ABAMD_debugged

dirOUT=~/gakkai/BioPhys_2014/

direconbase=econ_wdi_NVE_AMBER_TermOn_tune_dihedafclust_and_min_wotuning

basename=fig_enecon_2014-09-22

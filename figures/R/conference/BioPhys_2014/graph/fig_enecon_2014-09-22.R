 ...
 xrange <- c(0,16,16)
 xrange.axis <- c(0,14,14) #c(0,16,16)
 yrange <- c(-8,0,8) #c(-14,0,14) 
 yrange.axis <- c(-7,0,7) #yrange
 ...
 resname <- c(	"GLY", "ALA", "ASP", "GLU", "LEU", "ILE", "ASN", "GLN", "VAL", "HIE", "SER", "THR", "MET", "CYS", "PRO", "ARG", "LYS", "PHE", "TY3", "TRP", "ASH", "GLH", "HIP", "CYX", "CYM", "LYN"  )

 file.name=paste("/home/yamamori/gakkai/BioPhys_2014//eps/fig_enecon_2014-09-22.eps",sep='')
 ...
 for (i in 1:num.res) {
  ...
  plmGeneralwsrangelogu(data.names=file.names,
                       ...
                       warrow="T")
  text(8,-6,resname[i],cex=1.75)
  box(lwd=2.0)

  lines(c(1,16),c(-1.0,-1.0),lwd=2,lty="dashed",col="gray")

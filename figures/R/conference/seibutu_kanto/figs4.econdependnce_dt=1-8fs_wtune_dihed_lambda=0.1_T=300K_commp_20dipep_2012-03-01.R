...
name.res <- c( "ASN", "GLN", "LEU","SER", "LYS","ILE","ALA", "CYS", "MET", "THR", "VAL" )
...
name.out=paste("~/gakkai/seibutu_kanto/figs4.econdependnce_dt=1-8fs_wtune_dihed_lambda=0.1_T=300K_commp_20dipep_2012-03-01",sep='')
#OutTiff(name.out,w_val=600,h_val=480)
OutTiff(name.out,w_val=800,h_val=450)

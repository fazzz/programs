...
parafile=~/calspa/refcalc/REUS/AD/para/para_s_REUSMD_vac_ff99SB_Nbin=4x4_K=1_5ns_freq=10ps_2013-08-12.sh
...
paraRfil=${dirOUT}/graph/graph_REUS_AD_dihedtraj_2013-10-20.R
...
name.title <- paste("${dirOUT}/eps/fig_REUS_AD_dihedtraj_2013-10-20",sep="")

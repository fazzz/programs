...
paraRfil=${dirOUT}/graph/para_fig_a-b_comp_MuSTARMD-TAMD-REUS-REMD_AD_1Dpmf_2013-10-20.R
...
name.out <- "${dirOUT}/eps/fig_a-b_comp_MuSTARMD-TAMD-REUS-REMD_AD_1Dpmf_2013-10-20"
...
postscript(file.name,width=3.24,height=3.4,horizontal=FALSE,onefile=FALSE,paper="special")

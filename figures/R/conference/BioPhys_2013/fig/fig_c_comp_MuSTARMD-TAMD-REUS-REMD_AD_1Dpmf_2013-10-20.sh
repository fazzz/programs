...
paraRfil=${dirOUT}/graph/para_fig_c_comp_MuSTARMD-TREMD-REUS-TAMD-UmbSamp_AD_1Dpmf_2013-10-20.R
...
name.out <- "${dirOUT}/eps/fig_c_comp_MuSTARMD-TREMD-REUS-TAMD-UmbSamp_AD_1Dpmf_2013-10-20"
...
postscript(file.name,width=3.24,height=1.7,horizontal=FALSE,onefile=FALSE,paper="special")

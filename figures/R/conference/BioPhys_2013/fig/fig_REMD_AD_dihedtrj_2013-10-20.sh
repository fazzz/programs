...
parafile=~/calspa/refcalc/REMD/AD/para/para_s_REMD_vac_ff99SB_2013-08-17_TZ=300-1200.sh
...
paraRfil=${dirOUT}/graph/graph_REMD_AD_dihedtraj_2013-10-20.R
...
name.title <- paste("${dirOUT}/eps/fig_REMD_AD_dihedtraj_2013-10-20",sep="")
...
dir <- "~/calspa/refcalc/REMD/AD/s_REVAC_2012-07-23_${ff}/"

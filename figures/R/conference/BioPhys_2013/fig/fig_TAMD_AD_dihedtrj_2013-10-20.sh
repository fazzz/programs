...
parafile=~/calspa/TACCM/AD/para/2013-08-20/para_e_ff99SB_2013-08-20_mZ=100_Tz=800.sh
...
paraRfil=${dirOUT}/graph/graph_TAMD_AD_dihedtraj_2013-10-20.R
...
name.title <- paste("${dirOUT}/eps/fig_TAMD_AD_dihedtraj_2013-10-20",sep="")

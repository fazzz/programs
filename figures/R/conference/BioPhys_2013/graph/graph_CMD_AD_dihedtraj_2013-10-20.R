...
name.title <- paste("/home/yamamori/gakkai/BioPhys_2013/eps/fig_CMD_AD_dihedtraj_2013-10-20",sep="")
...
postscript(file.name,width=1.91,height=2.3716,horizontal=FALSE,onefile=FALSE,paper="special")

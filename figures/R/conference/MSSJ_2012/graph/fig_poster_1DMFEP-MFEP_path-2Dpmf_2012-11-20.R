...
name.path <- paste("/home/yamamori/calspa/MFEP/AD//pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2012-07-27/tau=1.0/mZ=100.00/TZ=700/SB_KZMAX=5000_NR4_woeljd0.001/nEX=1000/fq=10/path_TAA=300_TCG=300_0_5000_CG_K=15_@-1.4,1.1-@1.1,-0.8.txt",sep='')
name.out <- paste(dir,"/tiff/","fig_poster_1DMFEP-MFEP_path-2Dpmf_2012-11-20",sep='')
...
########################################################
# plmGeneralwsrange(data.names="/home/yamamori/calspa/MFEP/AD//pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2012-07-27/tau=1.0/mZ=100.00/TZ=700/SB_KZMAX=5000_NR4_woeljd0.001/nEX=1000/fq=10/path2_TAA=300_TCG=300_0_5000_CG_K=15_@-1.4,1.1-@1.1,-0.8.txt",     #
#                   sd.names="/home/yamamori/calspa/MFEP/AD//pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2012-07-27/tau=1.0/mZ=100.00/TZ=700/SB_KZMAX=5000_NR4_woeljd0.001/nEX=1000/fq=10/path2_TAA=300_TCG=300_0_5000_CG_K=15_@-1.4,1.1-@1.1,-0.8.txt",       #
#                   id.ys=id.ys,		       #
#                   ids.ys=ids.ys,		       #
#                   is.sen=rep(0,20),		       #

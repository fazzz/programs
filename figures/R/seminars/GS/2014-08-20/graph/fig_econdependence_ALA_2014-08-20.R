 ...
 direconfree <- c(	"/home/yamamori/calspa/TAMD_econ/dipep_2014-08-20_ABAMD_free_end_fixed_end/ALA/econ_wdi_NVE_AMBER_TermOn_tune_dihedafclust_and_min_wotuning_Term_free"  )
 direconfixed <- c(	"/home/yamamori/calspa/TAMD_econ/dipep_2014-08-20_ABAMD_free_end_fixed_end/ALA/econ_wdi_NVE_AMBER_TermOn_tune_dihedafclust_and_min_wotuning_CH3_Term_fixed"  )
 direconfixed2 <- c(	"/home/yamamori/calspa/TAMD_econ/dipep_2014-08-20_ABAMD_free_end_fixed_end/ALA/econ_wdi_NVE_AMBER_TermOn_tune_dihedafclust_and_min_wotuning_"  )
 proname <- c(	"ALADv"  )

 file.name=paste("/home/yamamori/seminars/GS/2014-08-20//eps/fig_econdependence_ALA_2014-08-20.eps",sep='')
 postscript(file.name,width=2.45,height=2.50,horizontal=FALSE,onefile=FALSE,paper="special")

...
file.name=paste("~/seminars/GS/2013-11-06/fig_spe_comp_20dipeptides_TAMDvsNMADAS_2013-07-09.eps",sep='')
...
for (i in 1:num.res) {
  ...
  plmGeneralwsrange(data.names=file.names,
                    ...
                    is.sen=sen,width=0.3,is.header="F")
  text(400,1.4,name.res[i],cex=1.5)
####################################################
##   if (i==1) {                                  ##

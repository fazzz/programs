...
dirbaseABApept <- "~/calspa/TAMD_econ/dipep_2013-10-17_af_minimize/"
dirbaseABApept2 <- "/misc/ivy3/yamamori/ajisai/TAMD_econ/TAMD_econ/dipep/"

file.name=paste("~/seminars/GS/2013-11-06/fig_econdependnce_dt=1-8fs_T=300K_commp_TAMDwtuningvsCMS_20dipep_wminimization_2013-11-06.eps",sep='')
...
for (i in 1:num.res) {
  ...
  file.names[1]=paste(dirbaseABApept,name.res[i],"/econ_wdi_NVE_AMBER_TermOn_tune_dihedafclust_and_minimize_2013-10-17_pc6/dtune=",tune[1],"/",name.res[i],"Dv_econ_",temp[1],"_100ps_1-",numini,".econ.rmsd.av",sep='')

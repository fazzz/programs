...
paraRfil=${dir}/fig/para_fig_TACCM_REMD_FG_2Dpmf_AD_2012-08-27.R
...
name.out <- "~/seminars/GS/2012-09-05/tiff/fig_TACCM_REMD_FG_2Dpmf_AD_2012-08-27_${name}"

tiffwidth <- ${tiffwidth}

tiffheight <- ${tiffheight}

source("~/seminars/GS/2012-09-05/graph/graph_TACCM_REMD_2Dpmf_AD_2012-08-27.R")

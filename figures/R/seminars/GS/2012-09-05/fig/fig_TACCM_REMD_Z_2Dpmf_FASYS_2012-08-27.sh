...
paraRfil=${dir}/fig/para_fig_TACCM_REMD_Z_2Dpmf_FASYS_2012-08-27.R
...
name.out <- "~/seminars/GS/2012-09-05/tiff/fig_TACCM_REMD_Z_2Dpmf_FASYS_2012-08-27"

tiffwidth <- ${tiffwidth}

tiffheight <- ${tiffheight}

source("~/seminars/GS/2012-09-05/graph/graph_TACCM_REMD_Z_2Dpmf_FASYS_2012-08-27.R")
EOF

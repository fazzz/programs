...
# yrange.axis <- yrange
 ...
 file.name=paste("/home/yamamori/seminars/GS/2015-03-18/eps/fig_econ_vdt_100ps_wdi_NVE_ABAMD_AMBER_Termon_comp_PC6-mLF_2015-03-18.eps",sep='')
 ...
 for (i in 1:num.res) {
  ...
  file.names[1]=paste(direconPC6[i],"/",proname[i],"_econ_300_100ps_1-",numini,".econ.rmsd.av",sep='')
  file.names[2]=paste(direconmLF[i],"/",proname[i],"_econ_300_100ps_1-",numini,".econ.rmsd.av",sep='')

...
parafilename=~/seminars/GS/2014-05-22/fig/para_energy_econservation_dependence_2014-05-22.sh
nx=7
ny=4 
mindt=1
maxdt=15 
...
dirOUT=~/seminars/GS/2014-05-22/
direconbase=econ_wdi_NVE_AMBER_TermOn_tune_dihedafclust_and_min_wotuning

basename=fig_energy_econservation_dependence_2014-05-22

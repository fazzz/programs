 ...
 pronamet <- c(	"GLY", "ALA", "ASP", "GLU", "LEU", "ILE", "ASN", "GLN", "VAL", "HIE", "SER", "THR", "MET", "CYS", "PRO", "ARG", "LYS", "PHE", "TY3", "TRP", "ASH", "GLH", "HIP", "CYX", "CYM", "LYN"  )

 file.name=paste("/home/yamamori/seminars/GS/2014-05-22//eps/fig_energy_econservation_dependence_2014-05-23.eps",sep='')
 postscript(file.name,width=11.45,height=7.00,horizontal=FALSE,onefile=FALSE,paper="special")

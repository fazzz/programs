...
file.name=paste("~/seminars/GS/2013-12-25/eps/fig_2-2_econdependence_ABAMD_w-wo-scaling_CMD_2013-12-25.eps",sep='')
...
#  file.names[2]=paste(dirbaseABAwoscaling,name.res[i],"/econ_wdi_NVE_AMBER_TermOn_tune_dihedafclust_and_min_wotunin#g_2013-12-02/",name.res[i],"Dv_econ_",temp[1],"_100ps_sa=",T,"_1-",numini,".econ_2.rmsd.av",sep='')

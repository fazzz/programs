...
name.res <- c( "ASN", "GLN", "VAL", "ILE", "ALA", "LYS", "THR", "TRP" )
...
file.name=paste("~/seminars/GS/2013-12-25/eps/fig_2_econdependence_ABAMD_w-wo-scaling_CMD_2013-12-25.eps",sep='')
postscript(file.name,width=7,height=4.2,horizontal=FALSE,onefile=FALSE,paper="special")

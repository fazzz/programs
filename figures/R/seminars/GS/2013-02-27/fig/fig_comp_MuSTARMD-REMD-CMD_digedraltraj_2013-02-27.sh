...
dirOUT=~/seminars/GS/2013-02-27

paraRfil=${dirOUT}/graph/graph_MuSTARMD-REMD-CMD_AD_dihedtraj_2013-02-27.R
...
name.title <- paste("${dirOUT}/tiff/fig_MuSTARMD-REMD-CMD_AD_dihedtraj_2013-02-26",sep="")

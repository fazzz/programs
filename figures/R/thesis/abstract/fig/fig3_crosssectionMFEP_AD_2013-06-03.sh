...
filename=${dir}/pmf2MGaussian_2012-10-10_bo_e_CG-FG_NH_2013-03-21/tau=${tau[1]}/mZ=${mZ[1]}/TZ=${TZs[1]}/${pname}/nEX=${numEX}/fq=${TLbase}/path2_TAA=${TAA}_TCG=${TCG}_${KZAAo[$mode]}_${KZCGo[$mode]}_${MODES[$mode]}_K=${K}_@${xi},${yi}-@${yi},${yf}_wx${minx}-${maxx}_wy${miny}-${maxy}_2.txt

paraRfil=${dirOUT}/graph/graph_fig_6_MFEP1D_2013-03-25.R
...
name.title <- paste("${dirOUT}/eps/fig3_crosssectionMFEP_AD_2013-06-03",sep="")

...
dirbase.nma <-"/home/yamamori/calspa/TAMD-s-ivy3/TAMD/spectrum/nmadas/"
dirbase.tamd <- "/misc/ivy3/yamamori/ajisai/TAMD/spectrum/tamd_ECEPP/testspace_debug_af_optq/"

name.out=paste("~/thesis/TAMD/eps/fig_Chapt5_spec_comp_tamd_nmadas.eps",sep='')
...
for (i in 1:num.res) {
  ...
  if (i==1) {
    legend(250,1.9,legend=c("ABA"),bty="n",

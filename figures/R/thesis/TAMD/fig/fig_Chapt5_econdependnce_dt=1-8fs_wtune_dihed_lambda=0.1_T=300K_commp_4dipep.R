...
name.out=paste("~/thesis/TAMD/eps/fig_Chapt5_econdependnce_dt=1-8fs_wtune_dihed_lambda=0.1_T=300K_commp_4dipep.eps",sep="")
postscript(name.out,width=4.0,height=4.0,horizontal=FALSE,onefile=FALSE,paper="special")
...
for (i in 1:num.res) {
  ...
  file.names[3]=paste("/home/yamamori/calspa/refcalc-s-ivy3/refcalc/dipep/",name.res[i],"/econ_wdi_NVE_100ps/",name.res[i],"Dv_econ_",temp[1],"_100ps_1-10_2ntc",".econ.rmsd.av",sep='')
...
#    par(mar=c(7.0,10.0,0.0,0.0))
    ...
    dirbase.name2 <-paste("~/calspa/TAMD-s-ivy3/TAMD/mod_parm/dipep",sep='')

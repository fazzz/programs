...
name.out=paste("~/thesis/TAMD/eps/fig_Chapt5_delta_spectrum_wtune_dihed_lambda=0.1_T=300K_commp_2dipep.eps",sep='')
...
################################################
  ## legend(100,1.0,legend=name.res[i],bty="n", ##
  ##        lty=c(1),cex=1.0,y.intersp=2,       ##
  ##        col="black",ncol=leg.col)           ##
  ################################################
...
#  yrange.axis2 <- c(-1,1,1)
  ...
  box(lwd=2.0)
  ############################################
  ## legend(legend=name.res[i],bty="n",     ##
  ##        lty=c(1),cex=1.0,y.intersp=2,   ##
  ##        col="black",ncol=leg.col)       ##
  ############################################

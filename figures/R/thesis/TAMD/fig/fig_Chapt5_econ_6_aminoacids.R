...
name.res <- c("GLN","GLU","HIE","ILE","PRO")
...
name.out=paste("~/thesis/TAMD/eps/fig_Chapt5_econ_6_aminoacids.eps",sep='')
...
#                      label.names=label.names,
  ...
  if ( i ==3 ) {
    axis(1,xaxp=c(1,6,5),lwd=2.0,cex.axis=1.0)
#    mtext(outer=T,label.x,side=1,line=5.0,cex=1.7)
  }

  if ( i==4 || i==5 || i==6 ) {
    axis(1,xaxp=c(0,6,6),lwd=2.0,cex.axis=1.0)
#    mtext(outer=T,label.x,side=1,line=5.0,cex=1.7)
  }
  
  if (i==1 ) {
    axis(2,yaxp=c(-7,0,7),lwd=2.0,cex.axis=1.0)
  }
  if (i==4 ) {
    axis(2,yaxp=c(-7,-1,6),lwd=2.0,cex.axis=1.0)
  }
  ######################################################
  ## if (i==1 || i==4  ) {                            ##

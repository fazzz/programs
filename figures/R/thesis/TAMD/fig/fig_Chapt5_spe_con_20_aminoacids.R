...
name.out=paste("~/thesis/TAMD/eps/fig_Chapt5_spe_con_20_aminoacids.eps",sep='')
postscript(name.out,width=6,height=6,horizontal=FALSE,onefile=FALSE,paper="special")
...
#                      label.names=label.names,
                      ...
                      ,warrow="F")
  text(360,0.6,name.res[i],cex=1.7)
  box(lwd=2.0)
  ...
  if ( i>=16 ) {
    axis(1,xaxp=c(0,400,4),lwd=2.0,cex.axis=1.0)
  }
  
  if (i==1 || i==6 || i==11 || i==16  ) {
    axis(2,yaxp=c(0,0.5,1),lwd=2.0,cex.axis=1.0)
  }

...
int main(int argc, char *argv[]) {
  ...
  for (i=0;i<numRE;++i) {
	...
	for (m=0;m<numRE;++m) {
	  ...
	  if (objmodeflag==CG1) {
	    //	    EZ=(ECG1-ECG1diff)+EAA+AAdata.e.p_e_t+AAdata.e.p_LJ_t+AAdata.e.p_e_14_t+AAdata.e.p_LJ_14_t+AAdata.e.p_d_t+AAdata.e.p_a_t+AAdata.e.p_b_t+ECG2+CGdata[1].e.p_t;
	    EZ=(ECG1-ECG1diff)+EAA+AAdata.e.p_e_t+AAdata.e.p_LJ_t+AAdata.e.p_e_14_t+AAdata.e.p_LJ_14_t+AAdata.e.p_d_t+AAdata.e.p_a_t+AAdata.e.p_b_t+ECG2+fact_NC*CGdata[1].e.p_natatt_t+fact_NNC*CGdata[1].e.p_repul_t+fact_b*CGdata[1].e.p_b_t+fact_a*CGdata[1].e.p_a_t+fact_t*CGdata[1].e.p_d_t;
	  }
	  if (objmodeflag==CG2) {
	    //	    EZ=(ECG2-ECG2diff)+EAA+AAdata.e.p_e_t+AAdata.e.p_LJ_t+AAdata.e.p_e_14_t+AAdata.e.p_LJ_14_t+AAdata.e.p_d_t+AAdata.e.p_a_t+AAdata.e.p_b_t+ECG1+CGdata[0].e.p_t;
	    EZ=(ECG2-ECG2diff)+EAA+AAdata.e.p_e_t+AAdata.e.p_LJ_t+AAdata.e.p_e_14_t+AAdata.e.p_LJ_14_t+AAdata.e.p_d_t+AAdata.e.p_a_t+AAdata.e.p_b_t+ECG1+fact_NC*CGdata[0].e.p_natatt_t+fact_NNC*CGdata[0].e.p_repul_t+fact_b*CGdata[0].e.p_b_t+fact_a*CGdata[0].e.p_a_t+fact_t*CGdata[0].e.p_d_t;
	  }
	  if (objmodeflag==FG) {
	    //	    EZ=(EAA-EAAdiff)+ECG1+CGdata[0].e.p_t+ECG2+CGdata[1].e.p_t;
	    EZ=(EAA-EAAdiff)+ECG1+fact_NC*CGdata[0].e.p_natatt_t+fact_NNC*CGdata[0].e.p_repul_t+fact_b*CGdata[0].e.p_b_t+fact_a*CGdata[0].e.p_a_t+fact_t*CGdata[0].e.p_d_t+ECG2+fact_NC*CGdata[1].e.p_natatt_t+fact_NNC*CGdata[1].e.p_repul_t+fact_b*CGdata[1].e.p_b_t+fact_a*CGdata[1].e.p_a_t+fact_t*CGdata[1].e.p_d_t;
	  }

...
int main(int argc, char *argv[]) {
  ...
  CGAAREMDreadInputs_testb(inputfile,Cdata.numatom/numEXT,numRE,my_rank,
  ...
  acc_ratio=MPI_CGAATREM_TACCM_MD_pep_NHC_MP1998_testb(my_rank,num_procs,tag,&status,

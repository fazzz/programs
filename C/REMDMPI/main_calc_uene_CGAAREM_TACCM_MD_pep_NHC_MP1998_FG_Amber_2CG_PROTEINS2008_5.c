...
int main(int argc, char *argv[]) {
  ...
  for (i=0;i<numRE;++i) {
	...
	for (m=0;m<numRE;++m) {
	  ...
	  if (objmodeflag==CG1) {
	    //	    EZ=-1.0*(((ECG1diff-ECG1)+EAA+AAdata.e.p_e_t+AAdata.e.p_LJ_t+AAdata.e.p_e_14_t+AAdata.e.p_LJ_14_t+AAdata.e.p_d_t+AAdata.e.p_a_t+AAdata.e.p_b_t)+ECG2+CGdata[1].e.p_t);
	    //	    EZ=(ECG1diff-ECG1)-1.0*(EAA+AAdata.e.p_e_t+AAdata.e.p_LJ_t+AAdata.e.p_e_14_t+AAdata.e.p_LJ_14_t+AAdata.e.p_d_t+AAdata.e.p_a_t+AAdata.e.p_b_t+ECG2+CGdata[1].e.p_t);

	    //	    EZ=-1.0*(((ECG1diff-ECG1)+EAA+AAdata.e.p_e_t+AAdata.e.p_LJ_t+AAdata.e.p_e_14_t+AAdata.e.p_LJ_14_t+AAdata.e.p_d_t+AAdata.e.p_a_t+AAdata.e.p_b_t)+ECG2+CGdata[1].e.p_t);

	    EZ=(ECG1diff-ECG1)-1.0*((+EAA+AAdata.e.p_e_t+AAdata.e.p_LJ_t+AAdata.e.p_e_14_t+AAdata.e.p_LJ_14_t+AAdata.e.p_d_t+AAdata.e.p_a_t+AAdata.e.p_b_t)+ECG2+CGdata[1].e.p_t);

	    //	    EZ=(ECG1diff-ECG1)-1.0*CGdata[0].e.p_t;
	  }
	  if (objmodeflag==CG2) {
	    //	    EZ=-1.0*(((ECG2diff-ECG2)+EAA+AAdata.e.p_e_t+AAdata.e.p_LJ_t+AAdata.e.p_e_14_t+AAdata.e.p_LJ_14_t+AAdata.e.p_d_t+AAdata.e.p_a_t+AAdata.e.p_b_t)+ECG1+CGdata[0].e.p_t);
	    //	    EZ=(ECG1diff-ECG1)-1.0*CGdata[1].e.p_t;
	    //	    EZ=(ECG2diff-ECG2)-1.0*(EAA+AAdata.e.p_e_t+AAdata.e.p_LJ_t+AAdata.e.p_e_14_t+AAdata.e.p_LJ_14_t+AAdata.e.p_d_t+AAdata.e.p_a_t+AAdata.e.p_b_t+ECG1+CGdata[0].e.p_t);
	  ...
	  if (objmodeflag==FG) {
	    ...
	    //	    EZ=(EAAdiff-EAA)+ECG1+CGdata[0].e.p_t+ECG2+CGdata[1].e.p_t;
	    //	    EZ=(EAAdiff-EAA)-1.0*(ECG1+CGdata[0].e.p_t+ECG2+CGdata[1].e.p_t);

	    //	    EZ=-1.0*(EAAdiff-EAA)-1.0*(ECG1+CGdata[0].e.p_t+ECG2+CGdata[1].e.p_t);

	    EZ=/*-1.0**/(EAAdiff-EAA)-1.0*(ECG1+CGdata[0].e.p_t+ECG2+CGdata[1].e.p_t);

	    //	    EZ=(EAAdiff-EAA)-1.0*(AAdata.e.p_e_t+AAdata.e.p_LJ_t+AAdata.e.p_e_14_t+AAdata.e.p_LJ_14_t+AAdata.e.p_d_t+AAdata.e.p_a_t+AAdata.e.p_b_t);

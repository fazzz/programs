...
int main(int argc, char *argv[]) {
  ...
  /*  for (i=0;i<AP.NBONH;++i) {
    for (j=0;j<2;++j) {
      if (AP.BH[i][j]==OHO+numatomini) AP.BH[i][j]=OHN+numatomini;
      else if (AP.BH[i][j]==HOO+numatomini) AP.BH[i][j]=HON+numatomini;
      else if (AP.BH[i][j]==C1O+numatomini) AP.BH[i][j]=C1N+numatomini;
      else if (AP.BH[i][j]==H1O+numatomini) AP.BH[i][j]=H1N+numatomini;
      else if (AP.BH[i][j]==C2O+numatomini) AP.BH[i][j]=C2N+numatomini;
      else if (AP.BH[i][j]==H2O+numatomini) AP.BH[i][j]=H2N+numatomini;
    }
  }
  
  for (i=0;i<AP.MBONA;++i) {
    for (j=0;j<2;++j) {
      if (AP.BA[i][j]==OHO+numatomini) AP.BA[i][j]=OHN+numatomini;
      else if (AP.BA[i][j]==HOO+numatomini) AP.BA[i][j]=HON+numatomini;
      else if (AP.BA[i][j]==C1O+numatomini) AP.BA[i][j]=C1N+numatomini;
      else if (AP.BA[i][j]==H1O+numatomini) AP.BA[i][j]=H1N+numatomini;
      else if (AP.BA[i][j]==C2O+numatomini) AP.BA[i][j]=C2N+numatomini;
      else if (AP.BA[i][j]==H2O+numatomini) AP.BA[i][j]=H2N+numatomini;
    }
    }

  for (i=0;i<AP.NTHETH;++i) {
    for (j=0;j<3;++j) {
      if (AP.TH[i][j]==OHO+numatomini) AP.TH[i][j]=OHN+numatomini;
      else if (AP.TH[i][j]==HOO+numatomini) AP.TH[i][j]=HON+numatomini;
      else if (AP.TH[i][j]==C1O+numatomini) AP.TH[i][j]=C1N+numatomini;
      else if (AP.TH[i][j]==H1O+numatomini) AP.TH[i][j]=H1N+numatomini;
      else if (AP.TH[i][j]==C2O+numatomini) AP.TH[i][j]=C2N+numatomini;
      else if (AP.TH[i][j]==H2O+numatomini) AP.TH[i][j]=H2N+numatomini;
    }
  }

  for (i=0;i<AP.MTHETA;++i) {
    for (j=0;j<3;++j) {
      if (AP.TA[i][j]==OHO+numatomini) AP.TA[i][j]=OHN+numatomini;
      else if (AP.TA[i][j]==HOO+numatomini) AP.TA[i][j]=HON+numatomini;
      else if (AP.TA[i][j]==C1O+numatomini) AP.TA[i][j]=C1N+numatomini;
      else if (AP.TA[i][j]==H1O+numatomini) AP.TA[i][j]=H1N+numatomini;
      else if (AP.TA[i][j]==C2O+numatomini) AP.TA[i][j]=C2N+numatomini;
      else if (AP.TA[i][j]==H2O+numatomini) AP.TA[i][j]=H2N+numatomini;
    }
    }*/

  for (i=0;i<AP.NPHIH;++i) {
    for (j=0;j<4;++j) {
      if ((abs(AP.PH[i][j])/3+1)==OHO+numatomini) 
	AP.PH[i][j]=(OHN+numatomini-1)*3;
      else if ((abs(AP.PH[i][j])/3+1)==HOO+numatomini) 
	AP.PH[i][j]=(HON+numatomini-1)*3;
      else if ((abs(AP.PH[i][j])/3+1)==C1O+numatomini) 
	AP.PH[i][j]=(C1N+numatomini-1)*3;
      else if ((abs(AP.PH[i][j])/3+1)==H1O+numatomini) 
	AP.PH[i][j]=(H1N+numatomini-1)*3;
      else if ((abs(AP.PH[i][j])/3+1)==C2O+numatomini) 
	AP.PH[i][j]=(C2N+numatomini-1)*3;
      else if ((abs(AP.PH[i][j])/3+1)==H2O+numatomini) 
	AP.PH[i][j]=(H2N+numatomini-1)*3;
    }
  ...
  for (i=0;i<AP.MPHIA;++i) {
    for (j=0;j<4;++j) {
      if ((abs(AP.PA[i][j])/3+1)==OHO+numatomini) 
	AP.PA[i][j]=(OHN+numatomini-1)*3;
      else if ((abs(AP.PA[i][j])/3+1)==HOO+numatomini) 
	AP.PA[i][j]=(HON+numatomini-1)*3;
      else if ((abs(AP.PA[i][j])/3+1)==C1O+numatomini) 
	AP.PA[i][j]=(C1N+numatomini-1)*3;
      else if ((abs(AP.PA[i][j])/3+1)==H1O+numatomini) 
	AP.PA[i][j]=(H1N+numatomini-1)*3;
      else if ((abs(AP.PA[i][j])/3+1)==C2O+numatomini) 
	AP.PA[i][j]=(C2N+numatomini-1)*3;
      else if ((abs(AP.PA[i][j])/3+1)==H2O+numatomini) 
	AP.PA[i][j]=(H2N+numatomini-1)*3;
    }
  }
...
int USAGE(char *progname) {
  printf("USAGE:\n");
  printf("[-h] help \n");
  printf("%s [-h] parmfilenamein parmfilenameout \n",progname);
}

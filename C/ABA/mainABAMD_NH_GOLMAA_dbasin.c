...
int main(int argc, char *argv[]) {
  ...
  for (i=0;i<numstep;++i) {
    ...
    if (TERMMODE==ON)
      ABA_integ_pret_Term(predict_Term,predict_Term2,correctt_Term,correct_Term2,vel_Term,dt);
    ...
    if (TERMMODE==ON)
      ABA_integ_cort_Term(predict_Term,predict_Term2,correctt_Term,correct_Term2,acc_Term,acc_Term2,vel_Term,dt);

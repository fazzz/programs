...
source ${PROG}/compile/libMPI.sh
#source ${WORK}/programs_trunk/compile/lib.sh

opt=$1
programname=$2
comsh=${PROG}/compile/compileMPI.sh
...
nfile=`expr ${nfile} - 2 `
if [ ${opt} == "g" -o ${opt} == "b" ]; then 
    mpicc -o ${programname}g -pg -g ${sourcefilename[@]} -L${HOME}/lib -I${HOME}/include  -L${HOME}/mylib -I${HOME}/myinclude -Xlinker -rpath -Xlinker ${HOME}/mylib -Xlinker -rpath -Xlinker ${HOME}/lib -L${HOME}/lib/glib-2.0 -I${HOME}/include/glib-2.0 -I${HOME}/lib/glib-2.0/include -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include  -L/lib64  ${libg[@]} ${libMPIg[@]} ;
...
if [ ${opt} == "o" -o ${opt} == "b" ]; then 
    mpicc -o ${programname} -O4 ${sourcefilename[@]} -L${HOME}/lib -I${HOME}/include -L${HOME}/mylib -I${HOME}/myinclude -Xlinker -rpath -Xlinker -I${HOME}/mylib -L${HOME}/lib/glib-2.0 -I${HOME}/include/glib-2.0 -I${HOME}/lib/glib-2.0/include -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include  -L/lib64 ${libo[@]} ${libMPIo[@]} ;

...
int readParmtopL(FILE *parmfile){
  ...
  AP.AMASS=(double *)emalloc(sizeof(double)*AP.NATOM); // 2014-07-22
  for (i=0;i<AP.NATOM;++i){
  ...
  AP.IAC=(int/*double*/ *)emalloc(sizeof(int/*double*/)*AP.NATOM); // 0811 // 2014-07-22
  for (i=0;i<AP.NATOM;++i){
  ...
  AP.NUMEX=(int/*double*/ *)emalloc(sizeof(int/*double*/)*AP.NATOM); // 0811 // 2014-07-22
  for (i=0;i<AP.NATOM;++i){
  ...
  AP.ICO=(int/*double*/ *)emalloc(sizeof(int/*double*/)*(AP.NTYPES)*(AP.NTYPES)); // 0811 // 2014-07-22
  ...
  AP.IPRES=(int *)emalloc(sizeof(int)*AP.NRES); // 2014-07-22
  for (i=0;i<AP.NRES;++i){
  ...
  AP.RK=(double *)emalloc(sizeof(double)*AP.NUMBND); // 2014-07-22
  ...
  AP.REQ=(double *)emalloc(sizeof(double)*AP.NUMBND); // 2014-07-22
  for (i=0;i<AP.NUMBND;++i){
  ...
  AP.TK=(double *)emalloc(sizeof(double)*AP.NUMANG); // 2014-07-22
  ...
  AP.TEQ=(double *)emalloc(sizeof(double)*AP.NUMANG); // 2014-07-22
  for (i=0;i<AP.NUMANG;++i){
  ...
  AP.PK=(double *)emalloc(sizeof(double)*AP.NPTRA); // 2014-07-22
  ...
  AP.PN=(double *)emalloc(sizeof(double)*AP.NPTRA); // 2014-07-22
  for (i=0;i<AP.NPTRA;++i){
  ...
  AP.PHASE=(double *)emalloc(sizeof(double)*AP.NPTRA); // 2014-07-22
  for (i=0;i<AP.NPTRA;++i){
  ...
  AP.SOLTY=(double *)emalloc(sizeof(double)*AP.NATYP); // 2014-07-22
  ...
  AP.CN1=(double *)emalloc(sizeof(double)*(AP.NTYPES)*(AP.NTYPES+1)/2); // 2014-07-22
  ...
  AP.CN2=(double *)emalloc(sizeof(double)*(AP.NTYPES)*(AP.NTYPES+1)/2); // 2014-07-22
  for (i=0;i<(AP.NTYPES)*(AP.NTYPES+1)/2;++i){
  ...
  AP.BH=(int/*double*/ **)emalloc(sizeof(int/*double*/ *)*AP.NBONH); // 0811 // 2014-07-22
  //  for (i=0;i<AP.NBONH;++i) AP.BH[i]=(int/*double*/ *)gcemalloc(sizeof(int/*double*/)*3); // 2014-07-22
  for (i=0;i<AP.NBONH;++i) AP.BH[i]=(int/*double*/ *)emalloc(sizeof(int/*double*/)*3); // 2014-07-22
  ...
  AP.BA=(int/*double*/ **)emalloc(sizeof(int/*double*/ *)*AP.NBONA); // 2014-07-22
  //  for (i=0;i<AP.NBONA;++i) AP.BA[i]=(int/*double*/ *)gcemalloc(sizeof(int/*double*/)*3); // 2014-07-22
  for (i=0;i<AP.NBONA;++i) AP.BA[i]=(int/*double*/ *)emalloc(sizeof(int/*double*/)*3); // 2014-07-22
  ...
  AP.TH=(int/*double*/ **)emalloc(sizeof(int/*double*/ *)*AP.NTHETH); // 2014-07-22
  ...
  AP.TA=(int/*double*/ **)emalloc(sizeof(int/*double*/ *)*AP.NTHETA); // 2014-07-22
  //  for (i=0;i<AP.NTHETA;++i) AP.TA[i]=(int/*double*/ *)gcemalloc(sizeof(int/*double*/)*4); // 2014-07-22
  for (i=0;i<AP.NTHETA;++i) AP.TA[i]=(int/*double*/ *)emalloc(sizeof(int/*double*/)*4); // 2014-07-22
  ...
  AP.PH=(int/*double*/ **)emalloc(sizeof(int/*double*/ *)*AP.NPHIH); // 2014-07-22
  ...
  AP.PA=(int/*double*/ **)emalloc(sizeof(int/*double*/ *)*AP.NPHIA); // 2014-07-22
  //  for (i=0;i<AP.NPHIA;++i) AP.PA[i]=(int/*double*/ *)gcemalloc(sizeof(int/*double*/)*5); // 2014-07-22
  for (i=0;i<AP.NPHIA;++i) AP.PA[i]=(int/*double*/ *)emalloc(sizeof(int/*double*/)*5); // 2014-07-22
  ...
  AP.NATEX=(int *)emalloc(sizeof(int)*AP.NEXT); // 2014-07-22
  for (i=0;i<AP.NEXT;++i){
  ...
  AP.ASOL=(double *)emalloc(sizeof(double)*AP.NPHB); // 2014-07-22
  for (i=0;i<AP.NPHB;++i){
  ...
  AP.BSOL=(double *)emalloc(sizeof(double)*AP.NPHB); // 2014-07-22
  for (i=0;i<AP.NPHB;++i){
  ...
  AP.HBCUT=(double *)emalloc(sizeof(double)*AP.NPHB); // 2014-07-22
  for (i=0;i<AP.NPHB;++i){
  ...
  AP.JOIN=(int *)emalloc(sizeof(int)*AP.NATOM); // 2014-07-22
  for (i=0;i<AP.NATOM;++i){
  ...
  AP.IROTAT=(int *)emalloc(sizeof(int)*AP.NATOM); // 2014-07-22
  for (i=0;i<AP.NATOM;++i){
  ...
  if (AP.IFBOX > 0) {
    ...
    AP.NSP=(int *)emalloc(sizeof(int)*AP.NSPM); // 2014-07-22
    for (i=0;i<AP.NSPM;++i){
  ...
  if (AP.IFPERT > 0) {
    ...
    AP.BPER=(int **)emalloc(sizeof(int *)*AP.NBPER); // 2014-07-22
    //    for (i=0;i<AP.NBPER;++i) AP.BPER[i]=(int *)gcemalloc(sizeof(int)*2); // 2014-07-22
    for (i=0;i<AP.NBPER;++i) AP.BPER[i]=(int *)emalloc(sizeof(int)*2); // 2014-07-22
    ...
    AP.ICBPER=(int *)emalloc(sizeof(int)*AP.NBPER*1); // 2014-07-22
    ...
    for (i=0;i<AP.NGPER;++i) AP.TPER[i]=(int *)emalloc(sizeof(int)*3); // 2014-07-22
    ...
    AP.PPER=(int **)emalloc(sizeof(int *)*AP.NDPER); // 2014-07-22
    ...
    for (i=0;i<AP.NDPER;++i)   AP.PPER=(int **)emalloc(sizeof(int *)*4);  // 2014-07-22
    ...
    AP.ICTPER=(int *)emalloc(sizeof(int)*AP.NDPER*2); // 2014-07-22
    ...
    AP.IAPER=(double *)emalloc(sizeof(double)*AP.NATOM); // 2014-07-22
    for (i=0;i<AP.NATOM;++i){
      fscanf(parmfile,"%lf",&AP.IAPER[i]);
    }

    //    AP.IACPER=(int *)gcemalloc(sizeof(int)*AP.NATOM); // 2014-07-22
    AP.IACPER=(int *)emalloc(sizeof(int)*AP.NATOM); // 2014-07-22
    for (i=0;i<AP.NATOM;++i){
    ...
    AP.CGPER=(double *)emalloc(sizeof(double)*AP.NATOM); // 2014-07-22
    for (i=0;i<AP.NATOM;++i){
...
if (AP.NPARM == 1) {
    ...
    AP.LES_TYPE=(int/*double*/ *)emalloc(sizeof(int/*double*/)*AP.NATOM); // 2014-07-22
    for (i=0;i<AP.NATOM;++i){
    ...
    AP.LES_FAC=(double *)emalloc(sizeof(double)*AP.NATOM); // 2014-07-22
    ...
    AP.LES_CNUM=(double *)emalloc(sizeof(double)*AP.NATOM); // 2014-07-22
    for (i=0;i<AP.NATOM;++i){
      fscanf(parmfile,"%lf",&AP.LES_CNUM[i]);
    }

    //    AP.LES_ID=(double *)gcemalloc(sizeof(double)*AP.NATOM); // 2014-07-22
    AP.LES_ID=(double *)emalloc(sizeof(double)*AP.NATOM); // 2014-07-22
    for (i=0;i<AP.NATOM;++i){

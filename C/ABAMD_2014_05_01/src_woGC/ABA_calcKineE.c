...
double ABA_calcKineE(double *KE,double *KEv,double *PEv,double KEobj,CLT *clt,double *crd,double *qvel,double q_NVT,double qvel_NVT,double s_NVT,int numclut,int numatom,int MODE){
  ...
  *KEv=0.0;
  *PEv=0.0;
  // vec=(double *)gcemalloc(sizeof(double)*6); // 2014-07-18
  // mat=(double *)gcemalloc(sizeof(double)*6*6); // 2014-07-18
  vec=(double *)emalloc(sizeof(double)*6); // 2014-07-18
  mat=(double *)emalloc(sizeof(double)*6*6); // 2014-07-18

...
void ABAs_restat_read_new(char *inputvelofilename,int numclut, // 2014-08-13
			  double *correct,double **correctt_Term,double **correctt_Term2,double correct_gzi[5], // 2014-08-13
			  int MODE,int TERMMODE) { // 2014-08-13
//void ABAs_restat_read_new(char *inputvelofilename,int numclut,
//			  double *correct,double correctt_Term[6][6],double **correctt_Term2,double correct_gzi[5],
//			  int MODE,int TERMMODE) {
  int i,j;
  FILE *inputvelofile;

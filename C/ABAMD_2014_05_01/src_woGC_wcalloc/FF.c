...
int ff_calcANGLE_force_Cartesian(double *f_a,double *cord){
  int i,j,k,l;
  int numatom;
  int type;
  double kang,ang_eq;
...
int ff_set_calcff(int numnb, int num14,FILE *inputfile, struct potential *ene){
  ...
  ff_set_NB_PARM((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,numatom);
...
int ff_set_calcffsp(struct potential *ene){
  ...
  (*ene).parm.indexnb=(int *)gcemalloc(sizeof(int)*numnb*2);
  (*ene).parm.index14=(int *)gcemalloc(sizeof(int)*num14*2);
  ff_set_non_bonding_index_2((*ene).parm.indexnb,(*ene).parm.index14);
...
double ff_calcff(double *crd, int numatom,struct potential *ene) {
  ...
  ff_calcDIHE((*ene).p_d,n_d,crd,1,0,0);
  ff_calcANGLE((*ene).p_a,crd);
  ff_calcBOND((*ene).p_b,crd);


  ff_calcFFNB((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e,(*ene).p_LJ,f_e,f_LJ,numnb,(*ene).parm.indexnb,numatom,crd,2,0);
  ff_calcFFNB((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e_14,(*ene).p_LJ_14,f_e_14,f_LJ_14,num14,(*ene).parm.index14,numatom,crd,2,0);
...
double ff_calcffandforce(double *crd, int numatom,struct potential *ene,struct force *f) {
  ...
  ff_calcFFNB((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e,(*ene).p_LJ,(*f).f_e,(*f).f_LJ,numnb,(*ene).parm.indexnb,numatom,crd,1,1);
  ff_calcFFNB((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e_14,(*ene).p_LJ_14,(*f).f_e_14,(*f).f_LJ_14,num14,(*ene).parm.index14,numatom,crd,1,1);

  n_d=(double *)gcemalloc(sizeof(double)*(AP.NPHIH+AP.MPHIA)); // 2014-07-09

  ff_calcDIHE((*ene).p_d,n_d,crd,1,0,0);
  ff_calcDIHE_force_Cartesian((*f).f_d,crd);

  ff_calcANGLE((*ene).p_a,crd);
  ff_calcANGLE_force_Cartesian((*f).f_a,crd);

  ff_calcBOND((*ene).p_b,crd);
  ff_calcBOND_force_Cartesian((*f).f_b,crd);
...
double ff_calcffandforce_14_6(double *crd, int numatom,struct potential *ene,struct force *f,double scale,int numrepul) { // 0911
  int i;
  int numnb,num14;
  double *n_d;
  ...
  ff_calcFFNB_14_6((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e,(*ene).p_LJ,(*f).f_e,(*f).f_LJ,numnb,(*ene).parm.indexnb,numatom,crd,1,1,scale,numrepul);
  ff_calcFFNB_14_6((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e_14,(*ene).p_LJ_14,(*f).f_e_14,(*f).f_LJ_14,num14,(*ene).parm.index14,numatom,crd,1,1,scale,numrepul);
...
double ff_calcffandforce_woH(double *crd, int numatom,struct potential *ene,struct force *f) {
  ...
  ff_calcFFNB_woH((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e,(*ene).p_LJ,(*f).f_e,(*f).f_LJ,numnb,(*ene).parm.indexnb,numatom,crd,1,1);
  ff_calcFFNB_woH((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e_14,(*ene).p_LJ_14,(*f).f_e_14,(*f).f_LJ_14,num14,(*ene).parm.index14,numatom,crd,1,1);

  n_d=(double *)gcemalloc(sizeof(double)*(AP.NPHIH+AP.MPHIA)); // 2014-07-09

  ff_calcDIHE_woH((*ene).p_d,n_d,crd,1,0,0);
  ff_calcDIHE_force_Cartesian_woH((*f).f_d,crd);

  ff_calcANGLE_woH((*ene).p_a,crd);
  ff_calcANGLE_force_Cartesian_woH((*f).f_a,crd);

  ff_calcBOND_woH/*_wFC100*/((*ene).p_b,crd);
  ff_calcBOND_force_Cartesian_woH/*_wFC100*/((*f).f_b,crd);
...
int ff_calcBOND_force_Cartesian_woH_wFC100(double *f_b,double *cord){
  ;
...
int ff_calcTorque(double *Q,double *cord,int numclut,int *nNumClutOfParent,int *terminal_atom_a,int *origin_atom_a) {
  ...
  inpindex=make_inpindex(&inpnumH,&inpnumA,indexclut,numclut,nNumClutOfParent,terminal_atom_a,origin_atom_a);

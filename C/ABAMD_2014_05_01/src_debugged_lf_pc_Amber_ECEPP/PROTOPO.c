#define _GNU_SOURCE   // 2015-02-16
#include <stdio.h>    // 2015-02-16
#include <stdlib.h>   // 2015-02-16
#include <string.h>   // 2015-02-16
...
int make_bp(int numatom,int *bp,int **bp_f , int *numb, char *name_atom_list, int aromaflag, int flagtoponon) {
  ...
  if (flagtoponon==ON) // 0811
    close_ring(numatom,bp_f,numb,name_atom_list);

  if (flagtoponon==OFF) { // 0811
    ...
    flagARG=ch_ARG(bp_f,numb,numatom,name_atom_list);
    if (flagARG==1) aromaflag=OFF;

    // ch_PRO_topo(bp_f,numb,numatom,name_atom_list);
    //  ch_PRO_topo2(bp_f,numb,numatom,name_atom_list);
...
int set_nb_pairs(int **matrix, int numatom, 
  ...
  for (i=0;i<numatom;++i) {
    for (j=i+1;j<numatom;++j) {
      if (matrix[i][j]==3) {
	//	pair1_4[i]=(int *)gcerealloc(pair1_4[i],sizeof(int)*(num14[i]+1)); // 2015-02-16
	pair1_4[i]=(int *)realloc(pair1_4[i],sizeof(int)*(num14[i]+1));            // 2015-02-16
	pair1_4[i][num14[i]]=j;
	num14[i]=num14[i]+1;
      }
      if (matrix[i][j]==-1) {
	//	pair1_5[i]=(int *)gcerealloc(pair1_5[i],sizeof(int)*(num1_5[i]+1)); // 2015-02-16
	pair1_5[i]=(int *)realloc(pair1_5[i],sizeof(int)*(num1_5[i]+1));            // 2015-02-16
...
int ch_aromatic_topo(int **bp_f, int *numb,
  ...
  for (i=0;i<numatom;++i) {
	...
	if (bp_f[ncZ][j]==ncE1) {
      ...
      numb[ncZ]+=1;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1)); // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));            // 2015-02-16
...
int ch_imso_topo(int **bp_f, int *numb,
  ...
  for (i=0;i<numatom;++i) {
	...
	/////////////////////////////////////////////////
	numb[ncE1]=1;
	//	bp_f[ncE1]=(int *)gcerealloc(bp_f[ncE1],sizeof(int)*(numb[ncE1])); // 2015-02-16
	bp_f[ncE1]=(int *)realloc(bp_f[ncE1],sizeof(int)*(numb[ncE1]));            // 2015-02-16
	bp_f[ncE1][0]=ncG;
	//	bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));  // 2015-02-16
	bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));             // 2015-02-16
	bp_f[ncG][numb[ncG]]=ncE1;
	...
	/////////////////////////////////////////////////
	numb[nnE2]=1;
	//	bp_f[nnE2]=(int *)gcerealloc(bp_f[nnE2],sizeof(int)*(numb[nnE2])); // 2015-02-16
	bp_f[nnE2]=(int *)realloc(bp_f[nnE2],sizeof(int)*(numb[nnE2]));            // 2015-02-16
	bp_f[nnE2][0]=ncG;
	//	bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));  // 2015-02-16
	bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));             // 2015-02-16
	...
	/////////////////////////////////////////////////
	numb[nhD1]=1;
	//	bp_f[nhD1]=(int *)gcerealloc(bp_f[nhD1],sizeof(int)*(numb[nhD1])); // 2015-02-16
	bp_f[nhD1]=(int *)realloc(bp_f[nhD1],sizeof(int)*(numb[nhD1]));            // 2015-02-16
	bp_f[nhD1][0]=ncG;
	//	bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));  // 2015-02-16
	bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));             // 2015-02-16
	bp_f[ncG][numb[ncG]]=nhD1;
	...
	/////////////////////////////////////////////////
	numb[nhE1]=1;
	//	bp_f[nhE1]=(int *)gcerealloc(bp_f[nhE1],sizeof(int)*(numb[nhE1])); // 2015-02-16
	bp_f[nhE1]=(int *)realloc(bp_f[nhE1],sizeof(int)*(numb[nhE1]));            // 2015-02-16
	bp_f[nhE1][0]=ncG;
	//	bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));  // 2015-02-16
	bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));             // 2015-02-16
	bp_f[ncG][numb[ncG]]=nhE1;
	...
	/////////////////////////////////////////////////
	numb[nhD2]=1;
	//	bp_f[nhD2]=(int *)gcerealloc(bp_f[nhD2],sizeof(int)*(numb[nhD2])); // 2015-02-16
	bp_f[nhD2]=(int *)realloc(bp_f[nhD2],sizeof(int)*(numb[nhD2]));            // 2015-02-16
	bp_f[nhD2][0]=ncG;
	//	bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));  // 2015-02-16
	bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));             // 2015-02-16
	bp_f[ncG][numb[ncG]]=nhD2;
	...
	/////////////////////////////////////////////////
	numb[nnD1]=1;
	//	bp_f[nnD1]=(int *)gcerealloc(bp_f[nnD1],sizeof(int)*(numb[nnD1]));  // 2015-02-16
	bp_f[nnD1]=(int *)realloc(bp_f[nnD1],sizeof(int)*(numb[nnD1]));             // 2015-02-16
	bp_f[nnD1][0]=ncG;
	//	bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));   // 2015-02-16
	bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));              // 2015-02-16
	...
	/////////////////////////////////////////////////
	numb[ncD2]=1;
	//	bp_f[ncD2]=(int *)gcerealloc(bp_f[ncD2],sizeof(int)*(numb[ncD2]));  // 2015-02-16
	bp_f[ncD2]=(int *)realloc(bp_f[ncD2],sizeof(int)*(numb[ncD2]));             // 2015-02-16
	bp_f[ncD2][0]=ncG;
	//	bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));   // 2015-02-16
	bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));              // 2015-02-16
	bp_f[ncG][numb[ncG]]=ncD2;
...
int ch_imdo_topo(int **bp_f, int *numb,
  ...
  for (i=0;i<numatom;++i) {
	...
	if ( m > maxnum2 ) {
      ...
      /////////////////////////////////////////////////
      numb[ncH]=1;
      //      bp_f[ncH]=(int *)gcerealloc(bp_f[ncH],sizeof(int)*(numb[ncH]));  // 2015-02-16
      bp_f[ncH]=(int *)realloc(bp_f[ncH],sizeof(int)*(numb[ncH]));             // 2015-02-16
      bp_f[ncH][0]=ncG;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1)); // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));            // 2015-02-16
      ...
      /////////////////////////////////////////////////
      numb[ncZ3]=1;
      //      bp_f[ncZ3]=(int *)gcerealloc(bp_f[ncZ3],sizeof(int)*(numb[ncZ3])); // 2015-02-16
      bp_f[ncZ3]=(int *)realloc(bp_f[ncZ3],sizeof(int)*(numb[ncZ3]));            // 2015-02-16
      bp_f[ncZ3][0]=ncG;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));  // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));             // 2015-02-16
      ...
      /////////////////////////////////////////////////
      numb[ncZ2]=1;
      //      bp_f[ncZ2]=(int *)gcerealloc(bp_f[ncZ2],sizeof(int)*(numb[ncZ2])); // 2015-02-16
      bp_f[ncZ2]=(int *)realloc(bp_f[ncZ2],sizeof(int)*(numb[ncZ2]));            // 2015-02-16
      bp_f[ncZ2][0]=ncG;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));  // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));             // 2015-02-16
      ...
      /////////////////////////////////////////////////
      numb[ncE3]=1;
      //      bp_f[ncE3]=(int *)gcerealloc(bp_f[ncE3],sizeof(int)*(numb[ncE3]));  // 2015-02-16
      bp_f[ncE3]=(int *)realloc(bp_f[ncE3],sizeof(int)*(numb[ncE3]));             // 2015-02-16
      bp_f[ncE3][0]=ncG;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));   // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));              // 2015-02-16
      ...
      /////////////////////////////////////////////////
      numb[ncE2]=1;
      //      bp_f[ncE2]=(int *)gcerealloc(bp_f[ncE2],sizeof(int)*(numb[ncE2]));  // 2015-02-16
      bp_f[ncE2]=(int *)realloc(bp_f[ncE2],sizeof(int)*(numb[ncE2]));             // 2015-02-16
      bp_f[ncE2][0]=ncG;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));   // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));              // 2015-02-16
      bp_f[ncG][numb[ncG]]=ncE2;
      ...
      /////////////////////////////////////////////////
      numb[ncD1]=1;
      //      bp_f[ncD1]=(int *)gcerealloc(bp_f[ncD1],sizeof(int)*(numb[ncD1]));  // 2015-02-16
      bp_f[ncD1]=(int *)realloc(bp_f[ncD1],sizeof(int)*(numb[ncD1]));             // 2015-02-16
      bp_f[ncD1][0]=ncG;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));   // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));              // 2015-02-16
      bp_f[ncG][numb[ncG]]=ncD1;
      ...
      /////////////////////////////////////////////////
      numb[nnE1]=1;
      //      bp_f[nnE1]=(int *)gcerealloc(bp_f[nnE1],sizeof(int)*(numb[nnE1]));  // 2015-02-16
      bp_f[nnE1]=(int *)realloc(bp_f[nnE1],sizeof(int)*(numb[nnE1]));             // 2015-02-16
      bp_f[nnE1][0]=ncG;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));   // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));              // 2015-02-16
      ...
      /////////////////////////////////////////////////
      numb[nhH]=1;
      //      bp_f[nhH]=(int *)gcerealloc(bp_f[nhH],sizeof(int)*(numb[nhH]));     // 2015-02-16
      bp_f[nhH]=(int *)realloc(bp_f[nhH],sizeof(int)*(numb[nhH]));                // 2015-02-16
      bp_f[nhH][0]=ncG;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));   // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));              // 2015-02-16
      ...
      /////////////////////////////////////////////////
      numb[nhZ3]=1;
      //      bp_f[nhZ3]=(int *)gcerealloc(bp_f[nhZ3],sizeof(int)*(numb[nhZ3]));  // 2015-02-16
      bp_f[nhZ3]=(int *)realloc(bp_f[nhZ3],sizeof(int)*(numb[nhZ3]));             // 2015-02-16
      bp_f[nhZ3][0]=ncG;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));   // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));              // 2015-02-16
      ...
      /////////////////////////////////////////////////
      numb[nhZ2]=1;
      //      bp_f[nhZ2]=(int *)gcerealloc(bp_f[nhZ2],sizeof(int)*(numb[nhZ2]));  // 2015-02-16
      bp_f[nhZ2]=(int *)realloc(bp_f[nhZ2],sizeof(int)*(numb[nhZ2]));             // 2015-02-16
      bp_f[nhZ2][0]=ncG;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));   // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));              // 2015-02-16
      ...
      /////////////////////////////////////////////////
      numb[nhE3]=1;
      //      bp_f[nhE3]=(int *)gcerealloc(bp_f[nhE3],sizeof(int)*(numb[nhE3]));  // 2015-02-16
      bp_f[nhE3]=(int *)realloc(bp_f[nhE3],sizeof(int)*(numb[nhE3]));             // 2015-02-16
      bp_f[nhE3][0]=ncG;
      //      bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));   // 2015-02-16
      bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]+1));              // 2015-02-16
...
int ch_PRO_topo(int **bp_f, int *numb,
  ...
  for (i=0;i<numatom;++i) {
	...
	//////////////////////////////////////////////////
	numb[nn]=1;
	//	bp_f[nn]=(int *)gcerealloc(bp_f[nn],sizeof(int)*(numb[nn])); // 2015-02-16
	bp_f[nn]=(int *)realloc(bp_f[nn],sizeof(int)*(numb[nn]));            // 2015-02-16
	bp_f[nn][0]=ncA;
	/****************************************************************************/
	...
	/////////////////////////////////////////////////
	numb[ncD]=1;
	//	bp_f[ncD]=(int *)gcerealloc(bp_f[ncD],sizeof(int)*(numb[ncD])); // 2015-02-16
	bp_f[ncD]=(int *)realloc(bp_f[ncD],sizeof(int)*(numb[ncD]));            // 2015-02-16
	bp_f[ncD][0]=ncA;
	//	bp_f[ncA]=(int *)gcerealloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));  // 2015-02-16
	bp_f[ncA]=(int *)realloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));             // 2015-02-16
	bp_f[ncA][numb[ncA]]=ncD;
	numb[ncA]+=1;
	/////////////////////////////////////////////////
	numb[ncG]=1;
	//	bp_f[ncG]=(int *)gcerealloc(bp_f[ncG],sizeof(int)*(numb[ncG]));    // 2015-02-16
	bp_f[ncG]=(int *)realloc(bp_f[ncG],sizeof(int)*(numb[ncG]));               // 2015-02-16
	bp_f[ncG][0]=ncA;
	//	bp_f[ncA]=(int *)gcerealloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));  // 2015-02-16
	bp_f[ncA]=(int *)realloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));             // 2015-02-16
	...
	/////////////////////////////////////////////////
	numb[ncB]=1;
	//	bp_f[ncB]=(int *)gcerealloc(bp_f[ncB],sizeof(int)*(numb[ncB]));    // 2015-02-16
	bp_f[ncB]=(int *)realloc(bp_f[ncB],sizeof(int)*(numb[ncB]));               // 2015-02-16
	bp_f[ncB][0]=ncA;
	/****************************************************************************/
        /* bp_f[ncA]=(int *)gcerealloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));	    */
	...
	/////////////////////////////////////////////////
	numb[nhG1]=1;
	//	bp_f[nhG1]=(int *)gcerealloc(bp_f[nhG1],sizeof(int)*(numb[nhG1]));  // 2015-02-16
	bp_f[nhG1]=(int *)realloc(bp_f[nhG1],sizeof(int)*(numb[nhG1]));             // 2015-02-16
	bp_f[nhG1][0]=ncA;
	//	bp_f[ncA]=(int *)gcerealloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));   // 2015-02-16
	bp_f[ncA]=(int *)realloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));              // 2015-02-16
	...
	/////////////////////////////////////////////////
	numb[nhG2]=1;
	//	bp_f[nhG2]=(int *)gcerealloc(bp_f[nhG2],sizeof(int)*(numb[nhG2]));  // 2015-02-16
	bp_f[nhG2]=(int *)realloc(bp_f[nhG2],sizeof(int)*(numb[nhG2]));             // 2015-02-16
	bp_f[nhG2][0]=ncA;
	//	bp_f[ncA]=(int *)gcerealloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));   // 2015-02-16
	bp_f[ncA]=(int *)realloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));              // 2015-02-16
	...
	/////////////////////////////////////////////////
	numb[nhB1]=1;
	//	bp_f[nhB1]=(int *)gcerealloc(bp_f[nhB1],sizeof(int)*(numb[nhB1]));  // 2015-02-16
	bp_f[ncA]=(int *)realloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));              // 2015-02-16
	bp_f[nhB1][0]=ncA;
	//	bp_f[ncA]=(int *)gcerealloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));   // 2015-02-16
	bp_f[ncA]=(int *)realloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));              // 2015-02-16
	...
	/////////////////////////////////////////////////
	numb[nhB2]=1;
	//	bp_f[nhB2]=(int *)gcerealloc(bp_f[nhB2],sizeof(int)*(numb[nhB2]));  // 2015-02-16
	bp_f[nhB2]=(int *)realloc(bp_f[nhB2],sizeof(int)*(numb[nhB2]));             // 2015-02-16
	bp_f[nhB2][0]=ncA;
	//	bp_f[ncA]=(int *)gcerealloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));   // 2015-02-16
	bp_f[ncA]=(int *)realloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));              // 2015-02-16
...
int ch_PRO_topo2(int **bp_f, int *numb,
  ...
  for (i=0;i<numatom;++i) {
	...
	numb[nhB1]=1;
	//	bp_f[nhB1]=(int *)gcerealloc(bp_f[nhB1],sizeof(int)*(numb[nhB1]));  // 2015-02-16
	bp_f[nhB1]=(int *)realloc(bp_f[nhB1],sizeof(int)*(numb[nhB1]));             // 2015-02-16
	bp_f[nhB1][0]=ncA;
	//	bp_f[ncA]=(int *)gcerealloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));   // 2015-02-16
	bp_f[ncA]=(int *)realloc(bp_f[ncA],sizeof(int)*(numb[ncA]+1));              // 2015-02-16
	bp_f[ncA][numb[ncA]]=nhB1;

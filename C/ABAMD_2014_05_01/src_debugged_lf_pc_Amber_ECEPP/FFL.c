...
int ffL_calcDIHE_force_Cartesian(double *f_d,double *cord) {
  ...
  //  n1=(double *)gcemalloc(sizeof(double)*3); // 2014-07-22
  //  n1=(double *)emalloc(sizeof(double)*3); // 2014-07-22 // 2014-09-05
  n1=(double *)calloc(3,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  n2=(double *)gcemalloc(sizeof(double)*3); // 2014-07-22
  //  n2=(double *)emalloc(sizeof(double)*3); // 2014-07-22 // 2014-09-05
  n2=(double *)calloc(3,sizeof(double)); // 2014-07-22 // 2014-09-05
...
int ffL_calcANGLE_force_Cartesian(double *f_a,double *cord){
  ...
  //  f_temp=(double *)gcemalloc(sizeof(double)*3*3); // 2014-07-22 // 2014-09-05
  //  f_temp=(double *)emalloc(sizeof(double)*3*3); // 2014-07-22
  f_temp=(double *)calloc(3*3,sizeof(double)); // 2014-07-22 // 2014-09-05
...
int ffL_set_calcffandforce(struct potential *ene, struct force *f){
  ...
  (*ene).parm.numnb=numnb;
  (*ene).parm.num14=num14;
  //  (*ene).parm.indexnb=(int *)gcemalloc(sizeof(int)*numnb*2); // 2014-07-22
  //  (*ene).parm.indexnb=(int *)emalloc(sizeof(int)*numnb*2); // 2014-07-22 // 2014-09-05
  (*ene).parm.indexnb=(int *)calloc(numnb*2,sizeof(int)); // 2014-07-22 // 2014-09-05
  //  (*ene).parm.index14=(int *)gcemalloc(sizeof(int)*num14*2); // 2014-07-22
  //  (*ene).parm.index14=(int *)emalloc(sizeof(int)*num14*2); // 2014-07-22 // 2014-09-05
  (*ene).parm.index14=(int *)calloc(num14*2,sizeof(int)); // 2014-07-22 // 2014-09-05
  ffL_set_non_bonding_index_2((*ene).parm.indexnb,(*ene).parm.index14);

  numatom=AP.NATOM;
  //  (*ene).parm.ele=(double *)gcemalloc(sizeof(double)*numatom); // 2014-07-22
  //  (*ene).parm.ele=(double *)emalloc(sizeof(double)*numatom); // 2014-07-22 // 2014-09-05
  (*ene).parm.ele=(double *)calloc(numatom,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*ene).parm.ALJ=(double *)gcemalloc(sizeof(double)*numatom*numatom); // 2014-07-22
  //  (*ene).parm.ALJ=(double *)emalloc(sizeof(double)*numatom*numatom); // 2014-07-22 // 2014-09-05
  (*ene).parm.ALJ=(double *)calloc(numatom*numatom,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*ene).parm.BLJ=(double *)gcemalloc(sizeof(double)*numatom*numatom); // 2014-07-22
  //  (*ene).parm.BLJ=(double *)emalloc(sizeof(double)*numatom*numatom); // 2014-07-22 // 2014-09-05
  (*ene).parm.BLJ=(double *)calloc(numatom*numatom,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*ene).p_e=(double *)gcemalloc(sizeof(double)*numnb); // 2014-07-22
  //  (*ene).p_e=(double *)emalloc(sizeof(double)*numnb); // 2014-07-22 // 2014-09-05
  (*ene).p_e=(double *)calloc(numnb,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*ene).p_LJ=(double *)gcemalloc(sizeof(double)*numnb); // 2014-07-22
  //  (*ene).p_LJ=(double *)emalloc(sizeof(double)*numnb); // 2014-07-22 // 2014-09-05
  (*ene).p_LJ=(double *)calloc(numnb,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*ene).p_e_14=(double *)gcemalloc(sizeof(double)*numnb); // 2014-07-22
  //  (*ene).p_e_14=(double *)emalloc(sizeof(double)*numnb); // 2014-07-22 // 2014-09-05
  (*ene).p_e_14=(double *)calloc(numnb,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*ene).p_LJ_14=(double *)gcemalloc(sizeof(double)*numnb); // 2014-07-22
  //  (*ene).p_LJ_14=(double *)emalloc(sizeof(double)*numnb); // 2014-07-22 // 2014-09-05
  (*ene).p_LJ_14=(double *)calloc(numnb,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*ene).p_d=(double *)gcemalloc(sizeof(double)*(AP.NPHIH+AP.MPHIA)); // 2014-07-22
  //  (*ene).p_d=(double *)emalloc(sizeof(double)*(AP.NPHIH+AP.MPHIA)); // 2014-07-22 // 2014-09-05
  (*ene).p_d=(double *)calloc((AP.NPHIH+AP.MPHIA),sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*ene).p_a=(double *)gcemalloc(sizeof(double)*(AP.NTHETH+AP.MTHETA)); // 2014-07-22
  //  (*ene).p_a=(double *)emalloc(sizeof(double)*(AP.NTHETH+AP.MTHETA)); // 2014-07-22 // 2014-09-05
  (*ene).p_a=(double *)calloc((AP.NTHETH+AP.MTHETA),sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*ene).p_b=(double *)gcemalloc(sizeof(double)*(AP.NBONH+AP.MBONA)); // 2014-07-22
  //  (*ene).p_b=(double *)emalloc(sizeof(double)*(AP.NBONH+AP.MBONA)); // 2014-07-22 // 2014-09-05
  (*ene).p_b=(double *)calloc((AP.NBONH+AP.MBONA),sizeof(double)); // 2014-07-22 // 014-09-05

  ffL_set_NB_PARM((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,numatom);

  //  (*f).f_t=(double *)gcemalloc(sizeof(double)*numatom*3); // 2014-07-22
  //  (*f).f_t=(double *)emalloc(sizeof(double)*numatom*3); // 2014-07-22 // 2014-09-05
  (*f).f_t=(double *)calloc(numatom*3,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*f).f_e=(double *)gcemalloc(sizeof(double)*numatom*3); // 2014-07-22
  //  (*f).f_e=(double *)emalloc(sizeof(double)*numatom*3); // 2014-07-22 // 2014-09-05
  (*f).f_e=(double *)calloc(numatom*3,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*f).f_LJ=(double *)gcemalloc(sizeof(double)*numatom*3); // 2014-07-22
  //  (*f).f_LJ=(double *)emalloc(sizeof(double)*numatom*3); // 2014-07-22 // 2014-09-05
  (*f).f_LJ=(double *)calloc(numatom*3,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*f).f_e_14=(double *)gcemalloc(sizeof(double)*numatom*3); // 2014-07-22
  //  (*f).f_e_14=(double *)emalloc(sizeof(double)*numatom*3); // 2014-07-22 // 2014-09-05
  (*f).f_e_14=(double *)calloc(numatom*3,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*f).f_LJ_14=(double *)gcemalloc(sizeof(double)*numatom*3); // 2014-07-22
  //  (*f).f_LJ_14=(double *)emalloc(sizeof(double)*numatom*3); // 2014-07-22 // 2014-09-05
  (*f).f_LJ_14=(double *)calloc(numatom*3,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*f).f_d=(double *)gcemalloc(sizeof(double)*numatom*3); // 2014-07-22
  //  (*f).f_d=(double *)emalloc(sizeof(double)*numatom*3); // 2014-07-22 // 2014-09-05
  (*f).f_d=(double *)calloc(numatom*3,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*f).f_a=(double *)gcemalloc(sizeof(double)*numatom*3); // 2014-07-22
  //  (*f).f_a=(double *)emalloc(sizeof(double)*numatom*3); // 2014-07-22 // 2014-09-05
  (*f).f_a=(double *)calloc(numatom*3,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  (*f).f_b=(double *)gcemalloc(sizeof(double)*numatom*3); // 2014-07-22
  //  (*f).f_b=(double *)emalloc(sizeof(double)*numatom*3); // 2014-07-22 // 2014-09-05
  (*f).f_b=(double *)calloc(numatom*3,sizeof(double)); // 2014-07-22 // 2014-09-05
...
double ffL_calcff(double *crd, int numatom,struct potential *ene) {
  ...
  f_e=(double *)gcemalloc(sizeof(double)*numatom*3);           // 2014-07-09
  f_LJ=(double *)gcemalloc(sizeof(double)*numatom*3);          // 2014-07-09
  f_e_14=(double *)gcemalloc(sizeof(double)*numatom*3);        // 2014-07-09
  f_LJ_14=(double *)gcemalloc(sizeof(double)*numatom*3);       // 2014-07-09
  n_d=(double *)gcemalloc(sizeof(double)*(AP.NPHIH+AP.MPHIA)); // 2014-07-09
...
double ffL_calcffandforce(double *crd, int numatom,struct potential *ene,struct force *f) {
  ...
  //  n_d=(double *)gcemalloc(sizeof(double)*(AP.NPHIH+AP.MPHIA)); // 2014-07-09 // 2014-07-22
  //  n_d=(double *)emalloc(sizeof(double)*(AP.NPHIH+AP.MPHIA)); // 2014-07-22 // 2014-09-05
  n_d=(double *)calloc((AP.NPHIH+AP.MPHIA),sizeof(double)); // 2014-07-22 // 2014-09-05
...
int ffL_calcTorque(double *Q,double *cord,int numclut,int *nNumClutOfParent,int *terminal_atom_a,int *origin_atom_a) {
  ...
  //  indexclut=(int *)gcemalloc(sizeof(int)*(AP.NPHIH+AP.MPHIA)); // 2014-07-22
  //  indexclut=(int *)emalloc(sizeof(int)*(AP.NPHIH+AP.MPHIA)); // 2014-07-22 // 2014-09-05
  indexclut=(int *)calloc((AP.NPHIH+AP.MPHIA),sizeof(int)); // 2014-07-22 // 2014-09-05
  ...
  for (i=0;i<AP.NPHIH;++i) {
    ...
    if (flag==ON) {
      ...
      //      printf("i=%d \n",i); // 2014-09-12
      n = indexclut[i]-1;
      if ( n!= -10 && n!= -1 ) {                                                            // 2014-09-12
	for (j=0;j<4;++j) for (k=0;k<3;++k) atom[j][k]=cord[abs(AP.PH[i][j])+k];  // 2014-09-12
	dihedang = pick_dihed(atom[0],atom[1],atom[2],atom[3],0,0.0);
...
int *ffL_make_inpindex(int *inpnumH,int *inpnumA,int *indexclut,int numclut,int *nNumClutOfParent,int *terminal_atom_a,int *origin_atom_a) {
  ...
  int FLAG=0; // 2014-09-12

  (*inpnumH)=0;
  (*inpnumA)=0;
  
  //  atom_dihed_pair=(int *)gcemalloc(sizeof(int)*(AP.NPHIH+AP.MPHIA)*6); // 2014-07-22
  //  atom_dihed_pair=(int *)emalloc(sizeof(int)*(AP.NPHIH+AP.MPHIA)*6); // 2014-07-22 // 2014-09-05
  atom_dihed_pair=(int *)calloc((AP.NPHIH+AP.MPHIA)*6,sizeof(int)); // 2014-07-22 // 2014-09-05
  //  inpindexH=(int *)gcemalloc(sizeof(int)*1); // 2014-07-22
  //  inpindexH=(int *)emalloc(sizeof(int)*1); // 2014-07-22 // 2014-09-05
  inpindexH=(int *)calloc(1,sizeof(int)); // 2014-07-22 // 2014-09-05
  //  inpindexA=(int *)gcemalloc(sizeof(int)*1); // 2014-07-22
  //  inpindexA=(int *)emalloc(sizeof(int)*1); // 2014-07-22 // 2014-09-05
  inpindexA=(int *)calloc(1,sizeof(int)); // 2014-07-22 // 2014-09-05
  ...
  for (k=0;k<AP.NPHIH;++k) {
    ...
    if (flag==OFF) {
      //      inpindexH[(*inpnumH)]=k;                                                     // 2014-08-13
      //      ++(*inpnumH);                                                                // 2014-08-13
      //      inpindexH=(int *)gcerealloc(inpindexH,sizeof(int)*(*inpnumH)); // 2014-07-22 // 2014-08-13
      //inpindexH=(int *)erealloc(inpindexH,sizeof(int)*(*inpnumH)); // 2014-07-22         // 2014-08-13
      ++(*inpnumH);                                                                        // 2014-08-13
      //inpindexH=(int *)gcerealloc(inpindexH,sizeof(int)*(*inpnumH)); // 2014-07-22       // 2014-08-13
      inpindexH=(int *)erealloc(inpindexH,sizeof(int)*(*inpnumH)); // 2014-07-22           // 2014-08-13
      inpindexH[(*inpnumH)-1]=k;                                                           // 2014-08-13
      //      printf("inpindexH[%d]=%d\n",(*inpnumH)-1,inpindexH[(*inpnumH)-1]); // 2014-09-12
    }
    ...
    //    if (k==21) {                                              // 2014-09-12
    //      printf("l =%d atom_dihed_pair=%d\n",l ,atom_dihed_pair[k/*][*/*6+l]);  // 2014-09-12
    //      printf("ll=%d atom_dihed_pair=%d\n",ll,atom_dihed_pair[k/*][*/*6+ll]); // 2014-09-12
    //
    //      for (i=0;i<numclut;++i){                                             // 2014-09-12
    //	p = nNumClutOfParent[i]-1;                                         // 2014-09-12 
    //	printf("p =%d i = %d terminal_atom_a[p]=%d origin_atom_a[i]=%d\n"  // 2014-09-12
    //	       ,l,i,terminal_atom_a[p],origin_atom_a[i]);                  // 2014-09-12
    //      }                                                                    // 2014-09-12
    //    }                                                                      // 2014-09-12
	...
	if (atom_dihed_pair[k/*][*/*6+l]==terminal_atom_a[p] && atom_dihed_pair[k/*][*/*6+ll]==origin_atom_a[i]) {
	  ...
	  //	  if (k==21) {                                              // 2014-09-12
	  //	    printf("IN  p=%d i=%d k=%d atom_dihed_pair(H) = %d\n"   // 2014-09-12
	  //		   ,p,i,k,atom_dihed_pair[(k)*6+5]);                // 2014-09-12
	  //	  }                                                         // 2014-09-12
	  FLAG=1; // 2014-09-12
	}
	//	else {                                                      // 2014-09-12
	//	  if (k==21) {                                              // 2014-09-12
	//    printf("OUT p=%d i=%d k=%d atom_dihed_pair(H) = %d\n"   // 2014-09-12
	//	   ,p,i,k,atom_dihed_pair[(k)*6+5]);                // 2014-09-12
	//	  }                                                         // 2014-09-12
	//	}                                                           // 2014-09-12
      } // 2014-08-13
    }
    if (FLAG==0)  atom_dihed_pair[k/*][*/*6+5] = -9;                // 2014-09-12
  }
  ...
  for (k=0;k<AP.MPHIA;++k) {
    ...
    if (flag==OFF) {
      //      inpindexA[(*inpnumA)]=k;                                                             // 2014-08-13
      //      ++(*inpnumA);									   // 2014-08-13
      //      //      inpindexA=(int *)gcerealloc(inpindexA,sizeof(int)*(*inpnumA)); // 2014-07-22 // 2014-08-13
      //      inpindexA=(int *)erealloc(inpindexA,sizeof(int)*(*inpnumA)); // 2014-07-22	   // 2014-08-13
      ++(*inpnumA);										   // 2014-08-13
      //      inpindexA=(int *)gcerealloc(inpindexA,sizeof(int)*(*inpnumA)); // 2014-07-22	   // 2014-08-13
      inpindexA=(int *)erealloc(inpindexA,sizeof(int)*(*inpnumA)); // 2014-07-22		   // 2014-08-13
      inpindexA[(*inpnumA)-1]=k;								   // 2014-08-13
      //      printf("inpindexA[%d]=%d\n",(*inpnumA)-1,inpindexA[(*inpnumH)-1]); // 2014-09-12
    }
	...
	if (atom_dihed_pair[(k+AP.NPHIH)/*][*/*6+l]==terminal_atom_a[p] && atom_dihed_pair[(k+AP.NPHIH)/*][*/*6+ll]==origin_atom_a[i]){
	  ...
	  atom_dihed_pair[(k+AP.NPHIH)/*][*/*6+5] = i+1;
	  	  if (k==21+AP.NPHIH) {                                     // 2014-09-12
	  	    printf("IN  p=%d i=%d k=%d atom_dihed_pair(A) = %d\n"   // 2014-09-12
	  		   ,p,i,k,atom_dihed_pair[(k+AP.NPHIH)*6+5]);       // 2014-09-12
	  	  }                                                         // 2014-09-12
	  FLAG=1; // 2014-09-12
	}
		else {                                                      // 2014-09-12
		  if (k+AP.NPHIH==21) {                                     // 2014-09-12
		    printf("OUT p=%d i=%d k=%d atom_dihed_pair(A) = %d\n"   // 2014-09-12
			   ,p,i,k,atom_dihed_pair[(k+AP.NPHIH)*6+5]);       // 2014-09-12
		  }                                                         // 2014-09-12
		}                                                           // 2014-09-12
      } // 2014-08-13
    }
    //    if (FLAG==0)  atom_dihed_pair[k+AP.NPHIH/*][*/*6+5] = -9;                // 2014-09-12 // 2014-10-14
    if (FLAG==0)  atom_dihed_pair[(k+AP.NPHIH)/*][*/*6+5] = -9;                // 2014-09-12 // 2014-10-14
  ...
  for (i=0;i<AP.NPHIH+AP.MPHIA;++i) {
    ...
    //    printf("indexclut[%d]=%d\n",i,indexclut[i]); // 2014-09-12
  }

  //  inpindex=(int *)gcerealloc(inpindex,sizeof(int)*((*inpnumH)+(*inpnumA)));
  //  inpindex=(int *)gcemalloc(sizeof(int)*((*inpnumH)+(*inpnumA))); // 2014-07-22
  //  inpindex=(int *)emalloc(sizeof(int)*((*inpnumH)+(*inpnumA))); // 2014-07-22 // 2014-09-05
  inpindex=(int *)calloc(((*inpnumH)+(*inpnumA)),sizeof(int)); // 2014-07-22 // 2014-09-05
  for (i=0;i<(*inpnumH);++i)
    inpindex[i]=inpindexH[i];
  for (i=0;i<(*inpnumA);++i)
    inpindex[i+(*inpnumH)]=inpindexA[i];

  free(atom_dihed_pair); // 2014-07-22
  free(inpindexH); // 2014-07-22
  free(inpindexA); // 2014-07-22

...
double ts_normalize(double *timeseries, int nums, int numv, double *timeseriesnorm) {
  ...
  //  ave=(double *)gcemalloc(sizeof(double)*numv); // 2014-07-22
  //  ave=(double *)emalloc(sizeof(double)*numv); // 2014-07-22 // 2014-09-05
  ave=(double *)calloc(numv,sizeof(double)); // 2014-07-22 // 2014-09-05
  //  var=(double *)gcemalloc(sizeof(double)*numv); // 2014-07-22
  //  var=(double *)emalloc(sizeof(double)*numv); // 2014-07-22 // 2014-09-05
  var=(double *)calloc(numv,sizeof(double)); // 2014-07-22 // 2014-09-05

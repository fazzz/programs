...
//double GearsConstant[6]; // 2014-08-13
//double Telar_Matrix[6][6]; // 2014-08-13
...
void ABA_integ_cort(double *qrot,double *qvel,double *q,double *qacc,double *predict,double *correct,double dt,int numclut) {
  ...
  for (i=0;i<numclut;++i) {
    ...
    //    cos(qrot[i]); // 2014-08-13
    //    cos(GearsConstant[0]); // 2014-08-13
    //    cos(dqacc); // 2014-08-13
    //    cos(qacc[i]); // 2014-08-13
    //    cos(predict[i*6+2]); // 2014-08-13
    //    cos(dt); // 2014-08-13
  }
...
void ABA_integ_pret_Term(double **predict_Term,double **predict_Term3,double /*correct_Term[6][6]2014-08-13*/**correct_Term,double **correct_Term3,double *vel_Term,double *delta_Term/*2014-08-13double delta_Term[6]/*2014-08-13*/,double dt){
  int i,j,k;
...
void ABA_integ_cort_Term(double **predict_Term,double **predict_Term3,double /*correct_Term[6][6]2014-08-13*/ **correct_Term,double **correct_Term3,double *acc_Term,double *acc_Term2,double *vel_Term,double *delta_Term,double dt) {
  int i,j,k;

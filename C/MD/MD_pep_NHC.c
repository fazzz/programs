...
int main(int argc, char *argv[]) {
  ...
  K=0.5*(3*numatom)*k_B*Tobj*UNITT;
  ...
  for (i=0;i<numstep;++i) {
    KE=MD_Propagetor_vV_NHC_wc(crd,vel,mass,numatom,dt,&e,&f,zeta,zeta_vel,bflag,aflag,dflag,eflag,LJflag,e14flag,LJ14flag);

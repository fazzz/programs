...
int main(int argc, char *argv[]) {
  ...
  while((c=getopt_long(argc,argv,"*hs:v:t:a:e:i:x:d:2:{:}:",long_opt,&opt_idx))!=-1) {
    switch(c) {
    case '*':
      MODE=NVE;
      break;
  ...
  GOLM_Clementi_MB_ff_set_calcff(&e,refcrd1,refcrd2,refcrdAA1,refcrdAA2,numCAatom,numatom,ep);

...
double MD_GOLMAAff_hybrid_calcff_check(double *crd, int numatom,
  ...
  ffL_calcffandforce_14DAB_woH(crd,numatom,&e,&f);
  ffL_calcffandforce_14DAB_woH(crddx,numatom,&e_dx,&f_dx);
  ffL_calcffandforce_14DAB_woH(crddy,numatom,&e_dy,&f_dy);
  ffL_calcffandforce_14DAB_woH(crddz,numatom,&e_dz,&f_dz);

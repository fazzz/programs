...
int main(int argc, char *argv[]) {
  ...
  double e1,e2,p_MB,**f1,**f2,**f_MB,kai;
  ...
  for (i=0;i<numstep;++i) {
    //    if (MODE==NVT)
    MD_Propagetor_NH_MP1998_FASYS(crd,vel,mass,&zeta,&V_zeta,Q,NfKT,numatom,&KEv,&PEv,dt,dt2,nc,wdt4,wdt2,de,d2,&e_GOLM,dih_equ1,dih_equ2,&p_MB,f_MB,&KE);

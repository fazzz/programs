...
! Local variables:
  ...
  do xy_idxlst_idx = 1, fft_blks_dim1 - 1
    ...
    call mpi_irecv(recv_buf(1, xy_idxlst_idx), numval, mpi_double_precision, &
                   recv_task, xyyxt_tag, mpi_comm_world, &
  ...
  do xy_idxlst_idx = 1, fft_blks_dim1 - 1
    ...
    call mpi_isend(send_buf(buf_base), buf_off - buf_base + 1, &
                   mpi_double_precision, send_task, xyyxt_tag, mpi_comm_world, &
...
! Local variables:
  ...
  do yz_idxlst_idx = 1, fft_blks_dim2 - 1
    ...
    call mpi_irecv(recv_buf(1, yz_idxlst_idx), numval, mpi_double_precision, &
                   recv_task, yzzyt_tag, mpi_comm_world, &
  ...
  do yz_idxlst_idx = 1, fft_blks_dim2 - 1
    ...
    call mpi_isend(send_buf(buf_base), buf_off - buf_base + 1, &
                   mpi_double_precision, send_task, yzzyt_tag, mpi_comm_world, &
...
! Local variables:
  ...
  do yz_idxlst_idx = 1, fft_blks_dim2 - 1
    ...
    call mpi_irecv(recv_buf(1, yz_idxlst_idx), numval, mpi_double_precision, &
                   recv_task, zyyzt_tag, mpi_comm_world, &
                   recv_req(yz_idxlst_idx), err_code_mpi) 
  end do
  ...
  do yz_idxlst_idx = 1, fft_blks_dim2 - 1
    ...
    call mpi_isend(send_buf(buf_base), buf_off - buf_base + 1, &
                   mpi_double_precision, send_task, zyyzt_tag, mpi_comm_world, &
                   send_req(yz_idxlst_idx), err_code_mpi)
...
! Local variables:
  ...
  do xy_idxlst_idx = 1, fft_blks_dim1 - 1
    ...
    call mpi_irecv(recv_buf(1, xy_idxlst_idx), numval, mpi_double_precision, &
                   recv_task, yxxyt_tag, mpi_comm_world, &
                   recv_req(xy_idxlst_idx), err_code_mpi) 
  end do
  ...
  do xy_idxlst_idx = 1, fft_blks_dim1 - 1
    ...
    call mpi_isend(send_buf(buf_base), buf_off - buf_base + 1, &
                   mpi_double_precision, send_task, yxxyt_tag, mpi_comm_world, &
                   send_req(xy_idxlst_idx), err_code_mpi)

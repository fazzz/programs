...
int ffLb_calcFFNB(double *ele, double *ALJ, double *BLJ,
  ...
  for(i=0;i<numnb;++i){
    ...
    len = sqrt(len2);
    p_e+=ele[num_a_prot]*ele[NUM_A_PROT]/(len);
...
int ffLb_calcANGLE_force_Cartesian(double *f_a,double *cord){
  int i,j,k,l;
  int numatom;
  int type;
  double kang,ang_eq;
...
int ffLb_set_calcffandforce(struct potential *ene, struct force *f){
  ...
  ffLb_set_non_bonding_index_1(&numnb,&num14);
  ...
  ffLb_set_non_bonding_index_2((*ene).parm.indexnb,(*ene).parm.index14);
  ...
  ffLb_set_NB_PARM((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,numatom);
...
double ffLb_calcff(double *crd, int numatom,struct potential *ene) {
  ...
  ffLb_calcDIHE((*ene).p_d,n_d,crd,1,0,0);
  ffLb_calcANGLE((*ene).p_a,crd);
  ffLb_calcBOND((*ene).p_b,crd);


  ffLb_calcFFNB((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e,(*ene).p_LJ,f_e,f_LJ,numnb,(*ene).parm.indexnb,numatom,crd,2,0);
  ffLb_calcFFNB((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e_14,(*ene).p_LJ_14,f_e_14,f_LJ_14,num14,(*ene).parm.index14,numatom,crd,2,0);
...
double ffLb_calcffandforce(double *crd, int numatom,struct potential *ene,struct force *f) {
  ...
  ffLb_calcFFNB((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e_t,(*ene).p_LJ_t,(*f).f_e,(*f).f_LJ,numnb,(*ene).parm.indexnb,numatom,crd);
  ffLb_calcFFNB((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e_14,(*ene).p_LJ_14_t,(*f).f_e_14_t,(*f).f_LJ_14,num14,(*ene).parm.index14,numatom,crd);

  ffLb_calcDIHE((*ene).p_d,n_d,crd,1,0,0);
  ffLb_calcDIHE_force_Cartesian((*f).f_d,crd);

  ffLb_calcANGLE((*ene).p_a,crd);
  ffLb_calcANGLE_force_Cartesian((*f).f_a,crd);

  ffLb_calcBOND((*ene).p_b,crd);
  ffLb_calcBOND_force_Cartesian((*f).f_b,crd);
...
double ffLb_calcffandforce_w14tune(double *crd, int numatom,struct potential *ene,struct force *f, int *atom_tune_pairs, double *tune_val, int numtune) {
  ...
  ffLb_calcFFNB((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e,(*ene).p_LJ,(*f).f_e,(*f).f_LJ,numnb,(*ene).parm.indexnb,numatom,crd,1,1);
  ffLb_calcFFNB_wtune/*_14*/((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e_14,(*ene).p_LJ_14,(*f).f_e_14,(*f).f_LJ_14,num14,(*ene).parm.index14,numatom,crd,1,1,atom_tune_pairs,tune_val,numtune);

  ffLb_calcDIHE((*ene).p_d,n_d,crd,1,0,0);
  ffLb_calcDIHE_force_Cartesian((*f).f_d,crd); // 1111
...
double ffLb_calcffandforce_14D_woH(double *crd, int numatom,struct potential *ene,struct force *f) {
  ...
  ffLb_calcFFNB_woH((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e_14,(*ene).p_LJ_14,(*f).f_e_14,(*f).f_LJ_14,num14,(*ene).parm.index14,numatom,crd,1,1);

  ffLb_calcDIHE_woH((*ene).p_d,n_d,crd,1,0,0);
...
double ffLb_calcffandforce_14DAB_woH(double *crd, int numatom,struct potential *ene,struct force *f) {
  ...
  ffLb_calcDIHE_woH((*ene).p_d,n_d,crd,1,0,0);
  ffLb_calcDIHE_force_Cartesian_woH((*f).f_d,crd);
  ...
  ffLb_calcANGLE_woH((*ene).p_a,crd);
  ffLb_calcANGLE_force_Cartesian_woH((*f).f_a,crd);

  ffLb_calcBOND_woH((*ene).p_b,crd);
  ffLb_calcBOND_force_Cartesian_woH((*f).f_b,crd);
...
double ffLb_calcffandforce_14vdWDAB_woH(double *crd, int numatom,struct potential *ene,struct force *f) {
  ...
  ffLb_calcFFNBvdW_woH((*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_LJ_14,(*f).f_LJ_14,num14,(*ene).parm.index14,numatom,crd,1,1);
...
double ffLb_calcffandforce_14_6(double *crd, int numatom,struct potential *ene,struct force *f,double scale,int numrepul) { // 0911
  int i;
  int numnb,num14;
  double *n_d;
  ...
  ffLb_calcFFNB_14_6((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e,(*ene).p_LJ,(*f).f_e,(*f).f_LJ,numnb,(*ene).parm.indexnb,numatom,crd,1,1,scale,numrepul);
  ffLb_calcFFNB_14_6((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e_14,(*ene).p_LJ_14,(*f).f_e_14,(*f).f_LJ_14,num14,(*ene).parm.index14,numatom,crd,1,1,scale,numrepul);
...
double ffLb_calcffandforce_woH(double *crd, int numatom,struct potential *ene,struct force *f) {
  ...
  ffLb_calcFFNB_woH((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e,(*ene).p_LJ,(*f).f_e,(*f).f_LJ,numnb,(*ene).parm.indexnb,numatom,crd,1,1);
  ffLb_calcFFNB_woH((*ene).parm.ele,(*ene).parm.ALJ,(*ene).parm.BLJ,(*ene).p_e_14,(*ene).p_LJ_14,(*f).f_e_14,(*f).f_LJ_14,num14,(*ene).parm.index14,numatom,crd,1,1);
  ...
  ffLb_calcBOND_woH/*_wFC100*/((*ene).p_b,crd);
  ffLb_calcBOND_force_Cartesian_woH/*_wFC100*/((*f).f_b,crd);
...
int ffLb_calcBOND_force_Cartesian_woH_wFC100(double *f_b,double *cord){
  ;
}
...
int ffLb_calcTorque(double *Q,double *cord,int numclut,int *nNumClutOfParent,int *terminal_atom_a,int *origin_atom_a) {
  ...
  inpindex=ffLb_make_inpindex(&inpnumH,&inpnumA,indexclut,numclut,nNumClutOfParent,terminal_atom_a,origin_atom_a);

...
double MD_Propagetor_NH_MP1998_AAFF_Amber_test(double *crd,double *vel,
					       double *mass,double *zeta,double *V_zeta,
...
double CE_TACCM_CGAA_test(double *crdAA,double *crdCG,double *Z, int numatom,int numZ,

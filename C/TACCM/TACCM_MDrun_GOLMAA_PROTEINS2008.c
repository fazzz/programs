...
double runTACCM_MD_NHC_MP1998_GOLMAA_PROTEINS2008(double *crd,double *vel, double *mass, int numatom,
						  ...
						  struct potential e ,struct potential_GOLMAA_PROTEINS2008 e_GOLM,
						  ...
						  FILE *trjfileZ, FILE *trjfilTheta, double *PEZ
						  //////////////// TACCM ///////////////////////
						  ) {
  int i,j,k;
  ...
  *varPEZ=0.0; *varKEZ=0.0; *varTZ=0.0;
  ...
  for (i=0;i<numstep;++i) {
    ...
    //    TACCM_MD_Propagetor_NH_MP1998_GOLMAA_PROTEINS2008(crd,vel,mass,&zeta,&V_zeta,
    //						      Q,NfKT,numatom,&KE,&KEv,&PEv,
    //						      dt,dt2,nc,wdt4,wdt2,
    //						      &e_GOLM,Z,numZ,theta,Kapa,pairs,&PEZ,pi);
    TACCM_MD_Propagetor_NH_MP1998_GOLMAA_PROTEINS2008(crd,vel,mass,zeta,V_zeta,
						      Q,NfKT,numatom,&KE,&KEv,&PEv,
						      dt,dt2,nc,wdt4,wdt2,
						      &e_GOLM,Z,numZ,theta,Kapa,pairs,PEZ,pi);

    //    TACCM_MD_Propagetor_NH_MP1998_Z(Z,velZ,massZ,theta,&zetaZ,&V_zetaZ,

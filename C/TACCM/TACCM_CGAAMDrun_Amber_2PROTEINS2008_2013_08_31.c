...
double runTACCM_2CG1FG_MD_NHC_MP1998_Amber_PROTEINS2008_2013_08_31(// AA ////////////////////////////////////////////
  ...
  for (i=0;i<numstep;++i) {
    ...
    PECG1=TACCM_MD_Propagetor_NH_MP1998_GOLMAA_PROTEINS2008_2013_08_31(crdCG1,velCG1,mass,zetaCG1,V_zetaCG1,
								       QCG1,NfKTCG1,numatom,&KECG1,&KEvCG1,&PEvCG1,
								       dt,dt2,nc,wdt4,wdt2,
								       &e_CG1,Z,numZ,thetaCG1,KZCG1,pairs,PEZCG1,pi,fact_b,fact_a,fact_t,fact_NC,fact_NNC);

    PECG2=TACCM_MD_Propagetor_NH_MP1998_GOLMAA_PROTEINS2008_2013_08_31(crdCG2,velCG2,mass,zetaCG2,V_zetaCG2,
								       QCG2,NfKTCG2,numatom,&KECG2,&KEvCG2,&PEvCG2,
								       dt,dt2,nc,wdt4,wdt2,
								       &e_CG2,Z,numZ,thetaCG2,KZCG2,pairs,PEZCG2,pi,fact_b,fact_a,fact_t,fact_NC,fact_NNC);

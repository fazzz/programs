...
double TACCMc_calc_eff_FF_MD(double *crd,int numatom, double *theta, double *Z,  int numZ,double Kapa, double **frcZ, int **pairs,double pi){
  int i,j,k;
  double PE=0.0;
  double *dvdpsi;
  double delta;

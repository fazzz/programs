...
int main(int argc, char *argv[]) {
  ...
  char *progname;
  char *inifile1name,*inifile2name,*inifile3name;
  char *parmtopname,*outfilename;
  ...
  SBAAff_set_parameters_protein_default(&ene1);
  SBAAff_set_parameters_protein_default(&ene2);
  SBAAff_set_parameters_protein_default(&ene1_trial);
  SBAAff_set_parameters_protein_default(&ene2_trial);

  SBAAMBff_set_protein_calcff(&ene1,&ene2,&deltaV,crd1,crd2,numatom);
  SBAAMBff_set_protein_calcff(&ene1_trial,&ene2_trial,&deltaV,crd1,crd2,numatom);

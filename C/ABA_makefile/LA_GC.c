...
double LAGC_outprod(double *v1,double *v2, double *v3) {
  double *mat;
...
int LAGC_invm(double *mat, double *invmat, int num) {
  ...
  mattemp=gcemalloc(sizeof(double)*m*n);
  test=gcemalloc(sizeof(double)*m*n);
...
int LAGC_invm2(double *mat, double *invmat, int num) {
  ...
  mattemp=(double *)gcemalloc(sizeof(double)*m*n);
...
double LAGC_vtmvmult(double *vec1,double *mat,double *vec2,int num) {
  ...
  matvec2=(double *)gcemalloc(sizeof(double)*num);
...
int LAGC_svd(double *mat, int m, int n, double *matU, double *matV, double *sv) {
  int i,j;
  double *matT;

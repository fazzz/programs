...
int main(int argc, char *argv[]) {
  ...
  while((c=getopt_long(argc,argv,"*fh+ovM:e:@:t:l:i:j:k:{:}:x:c:",long_opt,&opt_idx))!=-1) {
    switch(c) {
    case 'f':
      forceflag=OFF;
      break;
  ...
  // debug
  /*************************************************************************/
  /* numatom=clt[numclut-1].origin_atom_a-1+clt[numclut-1].num_atom_clust; */
  /* AP.NATOM=numatom;							   */
  /* numres=PTL_resnum(numatom);					   */
  /* AP.NRES=numres;							   */
  /*************************************************************************/
  // debug

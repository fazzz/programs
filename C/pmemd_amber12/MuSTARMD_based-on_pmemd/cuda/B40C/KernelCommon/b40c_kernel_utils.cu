...
//irg#if defined(_WIN64) || defined(__LP64__)
//irg	#define _B40C_LP64_ true
//irg	#define _B40C_ASM_PTR_ "l"
//irg#else
//irg	#define _B40C_LP64_ false
//irg	#define _B40C_ASM_PTR_ "r"
//irg#endif
         ...
         // 64-bit register cast for inlined asm
         #define _B40C_ASM_PTR_CAST_ unsigned long long*
#else
         #define _B40C_LP64_ false
         // 32-bit register modifier for inlined asm
         #define _B40C_ASM_PTR_ "r"
         // 32-bit register cast for inlined asm
         #define _B40C_ASM_PTR_CAST_ unsigned long*
#endif

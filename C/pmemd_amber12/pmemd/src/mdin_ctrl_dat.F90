...
! jar /= 0                               !Jarzynski sims are not currently
!                                        !supported on GPUs.
! n = 1,2,3,4                          
...
!  if ( jar /= 0 ) then
!      write(mdout, '(a)') 'CUDA (GPU): Implementation does not currently support the use of Jarzynski simulations.'
!      write(mdout, '(a)') '            Require jar == 0 (default).'
!      inerr = 1
!  end if

...
kClearForces_kernel()
{
    ...
    if ((threadIdx.x < 3) && (blockIdx.x == 0))
        cSim.pGBBRPosition[threadIdx.x]                 = cSim.GBTotalWarps[threadIdx.x];
...
#ifdef MPI
    LAUNCHERROR_NONBLOCKING("kClearForces");
#else    
...
#ifdef MPI 
    LAUNCHERROR_NONBLOCKING("kReduceForces");
#else
...
void kTransposeForces(gpuContext gpu)
{
    ...
    LAUNCHERROR_NONBLOCKING("kTransposeForces");  
}
#endif
...
#define KPMECALCULATECONSTRAINTSCOM_KERNEL kPMECalculateConstraintsCOM_kernel
#define KPMECALCULATESOLUTECONSTRAINTSCOM_KERNEL kPMECalculateSoluteConstraintsCOM_kernel
#define KPRESSURESCALECONSTRAINTCOORDINATES_KERNEL kPressureScaleConstraintCoordinates_kernel
...
#undef KPMECALCULATECONSTRAINTSCOM_KERNEL
#undef KPMECALCULATESOLUTECONSTRAINTSCOM_KERNEL
#undef KPRESSURESCALECONSTRAINTCOORDINATES_KERNEL
...
#define KPMECALCULATECONSTRAINTSCOM_KERNEL kPMECalculateConstraintsCOMLarge_kernel
#define KPMECALCULATESOLUTECONSTRAINTSCOM_KERNEL kPMECalculateSoluteConstraintsCOMLarge_kernel
#define KPRESSURESCALECONSTRAINTCOORDINATES_KERNEL kPressureScaleConstraintCoordinatesLarge_kernel
#include "kNTPKernels.h"
#undef KPMECALCULATECOM_KERNEL
#undef KPMECALCULATESOLUTECOM_KERNEL
#undef KPMECALCULATECOMKINETICENERGY_KERNEL

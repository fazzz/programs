...
void clearCudaSimulation(cudaSimulation& sim)
{
    ...
    sim.constraintSoluteMolecules           = 0;
    sim.constraintSoluteMoleculeStride      = 0;
    sim.constraintSoluteAtoms               = 0;
    sim.constraintSolventMolecules          = 0;
    sim.pConstraintSoluteAtomMoleculeID     = NULL;
    sim.pConstraintSoluteAtomConstraintID   = NULL;
    sim.pConstraintSoluteAtomMass           = NULL;
    sim.pConstraintSoluteAtomX              = NULL;
    sim.pConstraintSoluteAtomY              = NULL;
    sim.pConstraintSoluteAtomZ              = NULL;
    sim.pConstraintSoluteCOMX               = NULL;
    sim.pConstraintSoluteCOMY               = NULL;
    sim.pConstraintSoluteCOMZ               = NULL;
    sim.pConstraintSoluteUllCOMX            = NULL;
    sim.pConstraintSoluteUllCOMY            = NULL;
    sim.pConstraintSoluteUllCOMZ            = NULL;     
    sim.pConstraintSoluteInvMass            = NULL;
    sim.pConstraintSolventAtoms             = NULL;
    sim.pConstraintSolventConstraint        = NULL;
    sim.pConstraintSolventAtomMass1         = NULL;
    sim.pConstraintSolventAtomX1            = NULL;
    sim.pConstraintSolventAtomY1            = NULL;
    sim.pConstraintSolventAtomZ1            = NULL;
    sim.pConstraintSolventAtomMass2         = NULL;
    sim.pConstraintSolventAtomX2            = NULL;
    sim.pConstraintSolventAtomY2            = NULL;
    sim.pConstraintSolventAtomZ2            = NULL;
    sim.pConstraintSolventAtomMass3         = NULL;
    sim.pConstraintSolventAtomX3            = NULL;
    sim.pConstraintSolventAtomY3            = NULL;
    sim.pConstraintSolventAtomZ3            = NULL;
    sim.pConstraintSolventAtomMass4         = NULL;
    sim.pConstraintSolventAtomX4            = NULL;
    sim.pConstraintSolventAtomY4            = NULL;
    sim.pConstraintSolventAtomZ4            = NULL;
    sim.pConstraintSolventCOMX              = NULL;
    sim.pConstraintSolventCOMY              = NULL;    
    sim.pConstraintSolventCOMZ              = NULL;
    sim.pConstraintSolventInvMass           = NULL;
...
pbSolvent(NULL),
pbNTPData(NULL),
pbConstraintSoluteID(NULL),
pbConstraintSoluteAtom(NULL),
pbConstraintSolute(NULL),
pbConstraintUllSolute(NULL),
pbConstraintSolventAtoms(NULL),
pbConstraintSolventAtom(NULL),
pbConstraintSolventConstraint(NULL),
ee_plasma(0.0),
self_energy(0.0),
vdw_recip(0.0),
// AMD buffers
...
_gpuContext::~_gpuContext()
{
    ...
    delete pbSolvent;
    delete pbNTPData;
    delete pbConstraintSoluteID;
    delete pbConstraintSoluteAtom;
    delete pbConstraintSolute;
    delete pbConstraintUllSolute;
    delete pbConstraintSolventAtoms;
    delete pbConstraintSolventAtom;
    delete pbConstraintSolventConstraint;
    ...
    // Delete AMD buffers
    delete  pbAmdWeightsAndEnergy;       // AMD
    delete  pbAMDfwgtd;
    delete  pbAMDEDihedral;
}

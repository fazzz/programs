...
extern "C" void kCalculateSoluteConstraintsCOM(gpuContext gpu);
extern "C" void kPressurScaleConstraints(gpuContext gpu);
extern "C" void kCalculateConstraintsCOM(gpuContext gpu);
extern "C" void kReduceSoluteConstraintsCOM(gpuContext gpu);
extern "C" void kCalculateSoluteConstraintsCOM(gpuContext gpu);

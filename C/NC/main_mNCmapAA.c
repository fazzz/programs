...
int main(int argc, char *argv[]) {
  ...
  if (exflag==ON) {
	...
	/****************************************************************************************************/
        /* if ( ncmap[i][j]==0 &&  ncmap[j][k]==0 && ncmap[i][k]==0 ) {		   			    */
	/*   for (l=0;l<3;++l) {									    */
	...
	/*     ncmapexc[i][j]=-1;									    */
	/*   }												    */
	/*   else if ((dik < djk && ajki < 35.0*pi/180.0) || (dij < djk && aijk < 35.0*pi/180.0) ) {	    */
	/*     ncmapexc[j][k]=-1;									    */
	/*   }												    */
	/*   else if ((dij < dik && ajik < 35.0*pi/180.0) || (djk < dik && ajki < 35.0*pi/180.0) ) {	    */
	/*     ncmapexc[i][k]=-1;									    */
	/*   }												    */
	/* }												    */
        /****************************************************************************************************/

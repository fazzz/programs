...
CMSP  INCLUDE (BOND)
      INCLUDE '../common/bond'
CMSP  INCLUDE (CHARGE)
      INCLUDE '../common/charge'
CMSP  INCLUDE (COORD)
      INCLUDE '../common/coord'
CMSP  INCLUDE (REFRNC)
      INCLUDE '../common/refrnc'
CMSP  INCLUDE (SSPAIR)
      INCLUDE '../common/sspair'
CMSP  INCLUDE (TORSN0)
      INCLUDE '../common/torsn0'
CMSP  INCLUDE (VARANG)
      INCLUDE '../common/varang'
CMSP  INCLUDE (FMATRIX)
      INCLUDE '../common/fmatrix'
...
CMSP  INCLUDE (INTER0)
      INCLUDE '../common/inter0'
CMSP  INCLUDE (REFRNC)
      INCLUDE '../common/refrnc'
CMSP  INCLUDE (TABLE1)
      INCLUDE '../common/table1'
CMSP  INCLUDE (TORSN0)
      INCLUDE '../common/torsn0'
CMSP  INCLUDE (SSPAIR)
      INCLUDE '../common/sspair'
...
CMSP  INCLUDE (SIZE)
      INCLUDE '../common/size'
CMSP  INCLUDE (WKCAL1)
      INCLUDE '../common/wkcal1'
CMSP  INCLUDE (WKCAL2)
      INCLUDE '../common/wkcal2'
C     COMMON/NUMBER/  NUMATM,NUMVAR,NN2,NUMINT,NSS,NUMRES

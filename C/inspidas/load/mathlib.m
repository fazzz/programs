...
C...Translated by FPP 6.0 (3.06G3) 02/26/96  10:07:15   -dc
...
CDIR@ IVDEP
      DO 80 I = 1, J - KP1 + 1
         A(KP1+I-1,J) = W1(KP1+I-1)*EJ + A(KP1+I-1,J)
         A(KP1+I-1,J) = E(KP1+I-1)*W1J + A(KP1+I-1,J)
   80 CONTINUE
  100 CONTINUE
  110 A(K,K)=H
  120 CONTINUE
...
CDIR@    IVDEP
         DO 140 I = 1, NM1
            GERSCH=AMAX1(ABS@(E(1+I))+ABS@(W1(I))+ABS@(W1(1+I)),GERSCH)
            V(I,NV) = E(I)
  140    CONTINUE
      ELSE
CDIR@    IVDEP
...
C  QUICK SORT OF EIGENVALUES                ( BY C.HOARE )
  ...
  340 IF(IORD.LT.0)               GO TO 500
      NP1=N+1
      NE2=N/2
      IF (NE2.LT.NP1-NE2 .OR. NP1.LT.2) THEN
CDIR@    IVDEP
         DO 350 K = 1, NE2
            TEMP = E(K)
            E(K) = E(NP1-K)
...
CDIR@    IVDEP
         DO 140 I = 1, NM1
            GERSCH = AMAX1(SNGL(DABS(E(1+I))+DABS(W1(I))+DABS(W1(1+I))),
     1         GERSCH)
            V(I,NV) = E(I)
  140    CONTINUE
      ELSE

...
C        WRITE(IOUT06,5900) NXTWD,NAME
...
C         WRITE(IOUT06,6000) NXTWD,NAME
...
C        WRITE(IOUT06,6100) NXTWD,NAME
...
C                           (FROM UNIT 31)
        IF (NXTWD.EQ.'PREC') THEN
          CALL GTFLNM(NAME)
C        CALL OPENRD(IN31,'FORMATTED',NAME,IOUT06)
C        WRITE(IOUT06,6200) NXTWD,NAME
...
C              (UNFORMATTED, FROM UNIT 37)
      IF (SUBTAS.EQ.'GET ') THEN
        ...
        IF (NXTWD.EQ.'ANGL') THEN
          CALL GTFLNM(NAME)
C        CALL OPENRD(IN37,'UNFORMATTED',NAME,IOUT06)
C        WRITE(IOUT06,7100) NXTWD,NAME
...
C     CALL  READ21
C    WRITE(IOUT06,*)' NUMVAR=',NUMVAR,' NUMINT=',NUMINT,' NN2=',NN2
...
C      WRITE(IOUT06,401) TLIMIT,LOUT
        WRITE(IOUT02,401) TLIMIT,LOUT
        DO  2  I = 1, NUMRNG
C        WRITE(IOUT06,402) I, LRANGE(I),WVLTN0(I),LFUNC0(I),
C     &                  NITRTN(I),CONV0(I),LOMEGA(I)
...
C*          IF (KK.EQ.3)  A(I) = 10.D0
  ...
  23      CONTINUE
        ENDIF
C
C      WRITE(IOUT06,600) KRANGE,WVLTN,LFUNC,MAXITR,CONV,LOMEGA(K)
...
C                WRITE(IOUT06,650) J,VAR(J)/RAD
                WRITE(IOUT02,650) J,VAR(J)/RAD
                KOMEGA=1
              ENDIF
            ELSE
              IF (OMEGA.GT.HALFPI)  THEN
C                WRITE(IOUT06,660) J,VAR(J)/RAD
...
C                           (TO UNIT 32)
        IF (NXTWD.EQ.'ANGL') THEN
          CALL GTFLNM(NAME)
C          CALL OPENWT(IOUT32,'FORMATTED',NAME,IOUT06)
...
C                (FORMATTTED,TO UNIT 34)
        IF (NXTWD.EQ.'COOR') THEN
          ...
          IF (NXTWD.EQ.'FLEX') THEN
            CALL GTFLNM(NAME)
C           CALL OPENWT(IOUT34,'FORMATTED',NAME,IOUT06)
C           WRITE(IOUT06,6400) NXTWD,NAME
 6400       FORMAT(5X,A4,' WRITTEN TO ',A60)
            CALL OUTSTD(ISF,CO,ANGLES,KSSPER,TITLE1,ATNAME,
     &                  RENAME,NMBRES)
            CLOSE (IOUT34)
C           CALL OPENWT(IOUT34,'FORMATTED',NAME,IOUT06)
            CALL OUTSTD2(ISF,CO,ANGLES,KSSPER,TITLE1,ATNAME,
     &                  RENAME,NMBRES)
            CLOSE (IOUT34)
...
C                (UNFORMATTTED,TO UNIT 39)
        IF (NXTWD.EQ.'COOR') THEN
          ...
          FORMA='UNFORMATTED'
          IF (NXTWD.EQ.'OVER') FORMA='OVERWRITE  '
C         CALL OPENWT(IOUT39,FORMA,NAME,IOUT06)
C         WRITE(IOUT06,6600) NXTWD,NAME
...
C                           (TO UNIT 36)
        IF (NXTWD.EQ.'FMAT') THEN
          ...
          FORMA='UNFORMATTED'
          IF (NXTWD.EQ.'OVER') FORMA='OVERWRITE  '
C         CALL OPENWT(IOUT36,FORMA,NAME,IOUT06)
C     WRITE(IOUT06,6500) NXTWD,NAME
 6500    FORMAT(5X,A4,' WRITTEN TO ',A60)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c         DO 2222 N=1,3
cC            WRITE(IOUT06,'(4F14.10)') (ANGLES(J,N),J=1,4)
c 2222    CONTINUE
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
          CALL  DRVTVA(VAR,F0,DF,G,CO,CHARGE,ANGLES)
          CALL  OUTFMT(F0)
          CLOSE (IOUT36)
...
C
C     WRITE(IOUT06,210) TITLE1
C     WRITE(IOUT06,220) ITITL1,ID
...
C              WRITE(IOUT06,100) ATNAME(I),RENAME(I),NMBRES(I),DSQRT(D)
  ...
  30  CONTINUE
C
C      WRITE(IOUT06,110) JPR
C      WRITE(IOUT06,120) RMS
C      WRITE(IOUT06,210)
...
C        WRITE(IOUT06,130) I,WRK(1,I),WRK(3,I)
...
C     COMMON/NUMBER/  NUMATM,NUMVAR,NN2,NUMINT,NSS,NUMRES
      COMMON/TITLE1/  TITLE1
C
C      WRITE(IOUT06,300) TITLE1
C      WRITE(IOUT06,310) NUMATM,NUMVAR,NUMRES,NUMINT,NSS
...
C        WRITE(IOUT06,2000) ETOR,EES,ENB,ELOOP,ECYSTR,ETOTAL
        WRITE(IOUT02,2000) ETOR,EES,ENB,ELOOP,ECYSTR,ETOTAL

CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
        IF (ETOR.GT.1.0D4) THEN
           ETOR=1.0D4
        END IF
        IF (EES.GT.1.0D4) THEN
           EES=1.0D4
        END IF
        IF (ENB.GT.1.0D4) THEN
           ENB=1.0D4
        END IF
        IF (EES.GT.1.0D4) THEN
           EES=1.0D4
        END IF
        IF (ETOTAL.GT.1.0D4) THEN
           ETOTAL=1.0D4
        END IF

        IF (ETOR.LT.-1.0D4) THEN
           ETOR=-1.0D4
        END IF
        IF (EES.LT.-1.0D4) THEN
           EES=-1.0D4
        END IF
        IF (ENB.LT.-1.0D4) THEN
           ENB=-1.0D4
        END IF
        IF (EES.LT.-1.0D4) THEN
           EES=-1.0D4
        END IF
        IF (ETOTAL.LT.-1.0D4) THEN
           ETOTAL=-1.0D4
        END IF

        WRITE(*,'(6E20.10)') ETOR,EES,ENB,ELOOP,ECYSTR,ETOTAL
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C        CALL OPENWT(IOUT34,'FORMATTED',NAME,IOUT06)
C        CALL OUTSTD2_kai(ISF,CO,ANGLES,KSSPER,TITLE1,ATNAME,
C     &       RENAME,NMBRES)
C        CALL OUTSTD(ISF,CO,ANGLES,KSSPER,TITLE1,ATNAME,
C     &       RENAME,NMBRES)
C       CLOSE (IOUT34)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c$$$        IF(ISF.EQ.3) GO TO 190
c$$$        WRITE(IOUT34,'(3F14.10)') (ANGLES(L,IR+1),L=1,3)
c$$$C        CALL ADINFO(MNCH, 24,INFORM,NR,RECS)
c$$$        IF(LMAX.GT.0) THEN
c$$$           DO 400 L=1,LMAX
c$$$              WRITE(IOUT34,'(F14.10)')  ANGLES(3+L,IR+1)
c$$$ 400       CONTINUE
c$$$        END IF
c$$$ 190    CONTINUE
c$$$        WRITE(IOUT34,'(3F14.10)') (CO(J,N),J=1,3)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
C-----------------------------------------------------------------------
      IMPLICIT REAL*8 (A-H,O-Z)
C      CHARACTER    TITLE1*80,PROTID*72
      CHARACTER    TITLE1*100,PROTID*90
...
C        CHARACTER   INFORM*24,RECS*1600
        CHARACTER   INFORM*100,RECS*1600
...
C
      LEVEL=LEV5
       ...
       ATTRIB(1:1)=LATN(1:1)
       IF(ISF.NE.1) THEN
            WRITE(INFORM,'(3F9.5)') (CO(J,N),J=1,3)
C            WRITE(IOUT34,'(3F9.5)') (CO(J,N),J=1,3)
C            WRITE(INFORM,'(3F14.9)') (CO(J,N),J=1,3)
...
C
      ...
      END
C-----------------------------------------------------------------------
      SUBROUTINE  OUTSTD2(ISF,CO,ANGLES,KSSPER,TITLE1,SEQATM,
     &                   SEQAA,ISEQRS)
C-----------------------------------------------------------------------
      IMPLICIT REAL*8 (A-H,O-Z)
C      CHARACTER    TITLE1*80,PROTID*72
...
C
       ...
       ATTRIB(1:4)=LAAN(1:4)
       IF(ISF.EQ.3) GO TO 190
C            WRITE(INFORM,'(3F8.3)') (ANGLES(L,IR+1),L=1,3)
C            CALL ADINFO(MNCH, 24,INFORM,NR,RECS)
        IF(LMAX.GT.0) THEN
          DO 400 L=1,LMAX
C            WRITE(INFORM,'(F8.3)')  ANGLES(3+L,IR+1)
C            CALL ADINFO(KHI(L),8,INFORM,NR,RECS)
  400     CONTINUE
        END IF
  190 CONTINUE
C        CALL WRSTD(IOUT34,LEVEL,IDENT,ATTRIB,NR,RECS)
  200 CONTINUE
C
C* LEVEL5 *
C     <ATOM>  ATOM NAME, COORDINATE, S-S BOND
C
      LEVEL=LEV5
       ...
       ATTRIB(1:1)=LATN(1:1)
       IF(ISF.NE.1) THEN
C            WRITE(INFORM,'(3F9.5)') (CO(J,N),J=1,3)
            WRITE(IOUT34,'(3F14.10)') (CO(J,N),J=1,3)
C            WRITE(INFORM,'(3F14.9)') (CO(J,N),J=1,3)
C            CALL ADINFO(CKEY,24,INFORM,NR,RECS)
       ENDIF
C
C * S-S BOND *
      NSGO=0
C
  ...
  160    CONTINUE
         IF(NSGO.EQ.0) GO TO 180
  170    CONTINUE
C         WRITE(INFORM,'(A4,4X,I4.4,12X)') SEQATM(NSGO),ISEQRS(NSGO)
C         CALL ADINFO(SKEY,24,INFORM,NR,RECS)
       END IF
       END IF
C
  180  CONTINUE
C
C       IF(.NOT.(ISF.EQ.1 .AND. NSGO.EQ.0))
C     &        CALL WRSTD(IOUT34,LEVEL,IDENT,ATTRIB,NR,RECS)
C
           GO TO 150
C
...
C
      ...
      IF(.NOT.(NR .EQ. 0))  THEN
        IF(.NOT.(NR .EQ. 1))  THEN
          IF((RECS(100*(NR-1)+1 :100*(NR-1)+8)  .EQ. SPCE) .AND.
     &       (RECS(100*(NR-1)+41:100*(NR-1)+48) .EQ. SPCE)) THEN
              I=NR
              GO TO 2
          ELSE
              I=NR+1
      ...
      ENDIF
           ...
           GO TO 2
C
 1    RECS(100*(I-1)+ 1:100*(I-1)+100) = ' '
      RECS(100*(I-1)+ 9:100*(I-1)+16) = KEY
      RECS(100*(I-1)+17:100*(I-1)+40) = INFORM
      NNI = 25
        GO TO 4
 2    RECS(100*(I-1)+41:100*(I-1)+48) = KEY
      RECS(100*(I-1)+49:100*(I-1)+72) = INFORM
      NNI = 25
      I = I+1
C
 3     IF(NNI .GT. NI)  GOTO  3012
      RECS(100*(I-1)+ 1:100*(I-1)+100) = ' '
      RECS(100*(I-1)+ 9:100*(I-1)+16) = CONT
      RECS(100*(I-1)+17:100*(I-1)+40) = INFORM(NNI:NI)
      NNI = NNI + 24
 4     IF(.NOT.(NNI .GT. NI))GOTO  3015
          I=I+1
          GOTO  3012
C
 3015 RECS(100*(I-1)+41:100*(I-1)+48) = CONT
      RECS(100*(I-1)+49:100*(I-1)+72) = INFORM(NNI:NI)
      NNI = NNI + 24
      I=I+1
      IF(I.LE.LEN(RECS)/100) GOTO  3
C
 3012 NR = I-1
      RETURN
      END
...
C      WRITE(IOUT06,2020)
      WRITE(IOUT02,2020)
      STOP
C 2000 WRITE(IOUT06,2030)
 2000 WRITE(IOUT02,2030)
      WRITE(IOUT02,2030)
      STOP
...
CMSP  INCLUDE (SIZE)
      INCLUDE 'inc/size'
      COMMON/ENE000/  ETOR,EES,ENB,ELOOP,ECYSTR,ETHIS
C     COMMON/NUMBER/  NUMATM,NUMVAR,NN2,NUMINT,NSS,NUMRES
...
C
      DO  10  I = 1, NUMVAR
         ETHIS=A(I)*(ONE+NS(I)*DCOS(NB(I)*VAR(I)))
        IF (IFTOR(I).EQ.1)
...
C     SUBROUTINE  DRVTVA(NUMVAR,NN2,VAR,ETOTAL,F,G,CO,CHARGE)
      SUBROUTINE  DRVTVA(VAR,ETOTAL,F,G,CO,CHARGE,ANGLES)
      IMPLICIT REAL*8 (A-H,O-Z)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      DO 1111 N=1,40
         WRITE(*,'(3F14.10)') (CO(J,N),J=1,3)
 1111 CONTINUE

      DO 2222 N=1,10
         IF (VAR(N).LT.-3.141592653589793D0) THEN
            VAR(N)=VAR(N)+2.0*3.141592653589793D0
         END IF
         IF (VAR(N).GT.3.141592653589793D0) THEN
            VAR(N)=VAR(N)-2.0*3.141592653589793D0
         END IF
 2222 CONTINUE
...
C      DO 2222 N=1,5
         WRITE(*,'(10F20.10)') (VAR(N)*180D0/3.141592653589793D0,N=1,10)
C 2222 CONTINUE
...
C-----------------------------------------------------------------------
      SUBROUTINE  OUTSTD2_kai(ISF,CO,ANGLES,KSSPER,TITLE1,SEQATM,
     &                   SEQAA,ISEQRS)
C-----------------------------------------------------------------------
      IMPLICIT REAL*8 (A-H,O-Z)
C      CHARACTER    TITLE1*80,PROTID*72
...
C* LEVEL 1 *     <PROTEIN>
        PROTID(1:72)=TITLE1(1:72)
c        CALL HDLV0 (IOUT2,ISF,PROTID)
C* LEVEL 2 *     <UNIT>
        UNTID=OLDUNT
c        CALL HDUNIT(IOUT2,UNTID)
C* LEVEL 3 *     <CHAIN>
        CHNID=OLDCHN
c        CALL HDCHN (IOUT2,CHNID)
C
      DO 120 L=1,7
  120   KHI(L)=EKHI(L)
      IR0=0
...
C
      LEVEL=LEV5
       ...
       IF(ISF.NE.1) THEN
C            WRITE(INFORM,'(3F9.5)') (CO(J,N),J=1,3)
            WRITE(IOUT2,'(3F14.10)') (CO(J,N),J=1,3)
C            WRITE(INFORM,'(3F14.9)') (CO(J,N),J=1,3)
C            CALL ADINFO(CKEY,24,INFORM,NR,RECS)
       ENDIF
C

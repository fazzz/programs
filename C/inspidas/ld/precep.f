...
!      IF (ISKIP.EQ.0.AND.KMLAST.NE.NUMATM)  GO TO  240
        IF (ISKIP.EQ.0.AND.KMLAST.NE.NUMATM) THEN
          I4RUN = 0
          IOFF = 0
          KEY = 0
          INTATM(1,LEN) = IOFF
...
!CAK  COMMON/GEN032/ NUNITE(20),NMUNTE(18,20),NMNEWE(18,20),
      COMMON/GEN032/ NUNITE(20),NMUNTE(19,20),NMNEWE(19,20),
...
!    &   JCLDPL(MAXDBL)
      COMMON/DIPOL/ NUMDPL,NLDPL,NDPATM,KUNDPL(MAXDP),
     &   LSTDPL(MAXDP),LSTAMB(MAXDPL),JATDPL(MAXDBL),
     &   JCLDPL(MAXDBL)
      COMMON/DIPO2/ CHRGDP(MAXDP2),CHRGAM(MAXDBL)
C     COMMON/GEN100/ INUMRS,LIST(MAXRES),NPRE(MXRS1)
      COMMON/GEN100/ NPRE(MXRS1)

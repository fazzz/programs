...
int main(int argc, char *argv[]) {
  ...
  double dihed1,dihed2,dihed3,dihed4,dihed5,dihed6,dihed7;
  ...
  char *inputfilename;
  char *reffilename1="/home/yamamori/calspa/input/ADv_C7ax.crd";
  char *reffilename2="/home/yamamori/calspa/input/ADv_C7eq.crd";
  char *parmfilename="/home/yamamori/calspa/input/dipep/ALADv.top";
  char *clustfilename="/home/yamamori/calspa/input/dipep/ALADv.clt";
  ...
  l=0;
  for (dihed1=0.0;dihed1<2.0*pi;dihed1+=da) {
    for (dihed2=0.0;dihed2<2.0*pi;dihed2+=da) {
      for (dihed3=0.0;dihed3<2.0*pi;dihed3+=da) {
	for (dihed4=0.0;dihed4<2.0*pi;dihed4+=da) {
	  for (dihed5=0.0;dihed5<2.0*pi;dihed5+=da) {
	    for (dihed6=0.0;dihed6<2.0*pi;dihed6+=da) {
	      for (dihed7=0.0;dihed7<2.0*pi;dihed7+=da) {
		...
		for (i=0;i<numatom*3;++i) crd[i]=refcrd1[i];

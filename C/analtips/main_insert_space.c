...
int USAGE(char *progname) {
  printf("USAGE:%s \n",progname);
  printf("-h help \n");
  printf("-s num of specific line \n");
  printf("-d dismiss lines \n");
  printf(" numline numraw inputfilename outputfilename\n");
}

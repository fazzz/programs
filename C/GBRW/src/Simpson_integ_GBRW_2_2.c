...
double Simpson_integ_oneD_GBRW_C_GB(int N, double minx,double maxx,double x_i,double x_k,double bk,double h) {
  int i;
  double delta,delta2;
...
double Simpson_integ_oneD_GBRW_GB(int N, double minx,double maxx,double x_k,double h) {
  int i;
  double delta;
  double dx,x,*y,S1,S2,S=0.0;
  double dpi;

...
int main(int argc, char *argv[]) {
  ...
  if (drestflag==ON)
    fprintf(enedfile,"Etotal     Eelesta    ELJ      Eelesta14 ELJ14     Edihed    Eangle     Ebond    Erestaint\n");
  else
    fprintf(enedfile,"Etotal     Eelesta    ELJ      Eelesta14 ELJ14     Edihed    Eangle     Ebond    \n");
  if (drestflag==ON)
    fprintf(enefile,"#  Etotal     Etotal-Erest Erest\n");
  else
    fprintf(enefile,"#  Etotal     \n");
...
void USAGE(char *progname) {
  ...
  printf("-b beta\n");
  printf("-d dx\n");
  printf("USAGE: %s inifilename parmtopname enefilename enedfilename trjfilename (if -a drestfilename) \n", progname);
}

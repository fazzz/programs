...
int svd(double *mat, int m, int n, double *matU, double *matV, double *sv) {
  ...
  char jobu,jobvt;
  static long int m2,n2,lda,ldu,ldvt,info,lwork=5000/*200*/;
  static double work[5000/*200*/];
...
void invmat(double *mat, double *invmat, int num) {

  int i,j,k;
  double *mattemp,*test;
  static long int m,n,lda,info,piv[2500],lwork=2500;
  static double work[2500];

  m = num;
  n = num;
  lda=num;
  
  mattemp=(double *)malloc(sizeof(double)*m*n);

...
int E_step(int Nx, double minx,double dx,int Ny,double miny,double dy,
	   int K,int N, int *n, double **data,
	   double **nyu_k,double ***Sigma_k,double *pi_k, double ***gamma_nk,
	   double pi) {
  int i,j,k,n=0,nx,ny;
  double *x;

...
int main(int argc, char *argv[]) {
  ...
  while((c=getopt_long(argc,argv,"hdpo:x:a:y:m:f:i:j:1:2:t:",long_opt,&opt_idx))!=-1) {
    switch(c) {
    case 'd':
      flagd=ON;  break;
    case 'x':
  ...
  for (i=0;i<K;++i) {
    ...
    Sigma_k[i][0][0]=/*2000.0*//*1000.0/*200.0/*100.0*//*20.0*//*10.0*//*1.0*/Sigma_initial;
    Sigma_k[i][1][0]=/*2000.0*//*10.0*//*0.0*/Sigma_initial2;
    Sigma_k[i][0][1]=/*2000.0*//*10.0*//*0.0*/Sigma_initial2;
    Sigma_k[i][1][1]=/*2000.0*//*1000.0*//*200.0*//*100.0*//*20.0*//*10.0*//*1.0*/Sigma_initial;
  }

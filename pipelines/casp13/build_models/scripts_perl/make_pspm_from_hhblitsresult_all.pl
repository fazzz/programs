...
require "/home/yamamori/work/casp13/scripts_forte/a3mprocess.pl";
...
my $db = "/home/yamamori/DB/uniclust30_2017_10/uniclust30_2017_10";
...
#system("/home/tsukasa/lcl/bin/hhblits -n 3 -cpu 20 -all -i $infile -o $infile.hhr -oa3m $outa3m -ohhm $outhhm -d $db");
system("/home/yamamori/opt2/bin/hhblits -n 3 -cpu 20 -all -i $infile -o $infile.hhr -oa3m $outa3m -ohhm $outhhm -d $db");
#system("/home/tsukasa/lcl/bin/hhblits -n 3 -cpu 1 -i $infile -o $infile.hhr -oa3m $outa3m -ohhm $outhhm -d $db");
...
#	system("python /home/tsukasa/casp_database/forte/scripts/a3m_to_fas.py $infile $outfile");
	system("~/opt2/anaconda3/bin/python /home/yamamori/work/casp13/scripts_forte/a3m_to_fas.py $infile $outfile");
#	system("java -jar /home/tsukasa/casp_database/forte/scripts/FastaToProfile.jar -i $outfile -o $prffile");
	system("java -jar /home/yamamori/work/casp13/scripts_forte/FastaToProfile.jar -i $outfile -o $prffile");
...
#	system("python /home/tsukasa/casp_database/forte/scripts/a3m_to_fas.py $outfile.profin $outfile");
	system("~/opt2/anaconda3/bin/python /home/yamamori/work/casp13/scripts_forte/a3m_to_fas.py $outfile.profin $outfile");
#	system("java -Xmx512g -jar /home/tsukasa/casp_database/forte/scripts/FastaToProfile.jar -i $outfile -o $prffile");
	system("java -Xmx512g -jar /home/yamamori/work/casp13/scripts_forte/FastaToProfile.jar -i $outfile -o $prffile");
	#system("java -jar /home/tsukasa/casp_database/forte/scripts/FastaToProfile.jar -i $outfile -o $prffile");
#	unlink($outfile);
